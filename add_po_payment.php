            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Purchase Payment (IEMI)</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item">Purchase</li>
                            <li class="breadcrumb-item active">Add Purchase Payment (IEMI)</li>
                        </ul>
                    </div>            
...
<?php
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                   <form action="operations/add_po_payment.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="body">
                            <div class="row clearfix"> 
                              <div class="col-md-3 col-sm-12">
                                      ...
                                      <input type="hidden" name="edit" value="0">
                                        <select class="form-control po"  name="po" onchange="get_detail();" >
                                          <option selected="" value="">-- Chose One --</option>
                                           <?php
                                            $sql="SELECT * FROM tbl_purchase where payment_status='Pending' and amount_payed='0' and created_by='$userid' and iemi='1'"; 
                                            foreach ($conn->query($sql) as $row){
                                ...
                                <div class="col-md-8 col-sm-12" >
                                    ...
                                    <div class="form-group">     
                                    <textarea name="narration" class="form-control"  row="1" id="po_remarks"><?php echo $po_remarks; ?></textarea>   
                                ...
                                <div class="col-md-12 col-sm-12" hidden="">
                                    ...
                                    <div class="form-group">        
                                        <textarea name="po_remarks" class="form-control"  row="1" id="narration"><?php echo $narration; ?></textarea>
                                </div>
                              </div>
                                </div>
                            </div><br>
...
if(amount_payed==0 || isNaN(amount_payed) || amount_payed=='')
{
  alert('Opps! Amount Payed must be greater than Zero..!');
    $('#amount_remaining').val('');
    $('#amount_payed').val('');
    $('#amount_payed').focus();
...
success: function(responce){
  $("#cash_bank").val('');
  $("#cash_bank").val(responce).toFixed(2);
