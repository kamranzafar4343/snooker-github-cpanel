...
?>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Bank List</h2>
                        <ul class="breadcrumb">
  ...
  <strong>Great!</strong> Bank Added Succesfully.
</div>
  ...
  <strong>Great!</strong> Bank Updated Succesfully.
</div>
              <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
  ...
  <strong>Great ! </strong>Bank Deleted Successfully.
</div>
                            <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
              ...
              <?php
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover js-basic-example dataTable table-custom table-striped m-b-0 c_list">
                                    <thead >
                                      <?php if($c_write=='1'){?>
                                        <tr>
                                            <th colspan="8" class="text-right"><a href="add_bank.php"><button type="button" class="btn btn-success">Add New</button></a></th>
                                        </tr>
                                         <?php }?>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php 
                        error_reporting(0);
                        $sql=mysqli_query($conn, "SELECT * FROM tbl_bank ");
                        $count=0;
                        ...
                        ?>
                                        <tr>
                                            ...
                                            <td><span><?php echo $bank;?></span></td>
                                           <?php if($c_write=='1'){?>
                                            <td>
                                                <a href="add_bank.php?edit_id=<?php echo $id;?>"><button type="button" class="btn btn-sm btn-outline-secondary" title="Edit"><i class="fa fa-edit"></i></button></a>
                                                <a href="operations/delete_bank.php?id=<?php echo $id;?>"><button type="button" class="btn btn-sm btn-outline-danger js-sweetalert" title="Delete" data-type="confirm"><i class="fa fa-trash-o"></i></button></a>
                                            </td>
                                             <?php }?>
                                        </tr>
<?php }?>
