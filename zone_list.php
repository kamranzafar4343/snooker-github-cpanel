...
?>
  ...
  <strong>Great ! </strong>Zone Deleted Successfully.
</div>
  ...
  <strong>Great!</strong> Zone Added Succesfully.
</div>
              <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
  ...
  <strong>Opps!</strong>Failed to Add Zone.
</div>
                            <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
  ...
  <strong>Opps!</strong> Failed to Delete Zone, Because Sub Zones related to Zone Exist..!
</div>
                            <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
             ...
             ?>
                        <div class="body">
                          ...
                          <button  class="btn btn-success m-b-15" type="button">
                                 <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Zone
                            </button>
                          </a>
                          </div>
                          <?php }?>
                        ...
                        ?>
                                        <tr>
                                          ...
                                          <?php if($c_write=='1'){?>
                                            <td>
                                                <a href="zone.php?edit_id=<?php echo $id;?>"><button type="button" class="btn btn-sm btn-outline-secondary" title="Edit"><i class="fa fa-edit"></i></button></a>
                                                <a href="operations/delete.php?zone_id=<?php echo $id;?>"><button type="button" class="btn btn-sm btn-outline-danger js-sweetalert" title="Delete" onclick="return confirm('Are you sure want to delete');"><i class="fa fa-trash-o"></i></button></a>
                                            </td>
                                            <?php }?>
                                        </tr>
<?php }?>
