            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Installment (IEMI)</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"><i class="icon-home"></i></a></li>                            
                            <li class="breadcrumb-item">Installment (IEMI)</li>
    ...
    <?php }?>
                    <div class="card">
                        <div class="body">
                                ...
                                <form action="operations/installment.php" method="post"  enctype="multipart/form-data">
                            <div class="row clearfix">
                               ...
                               <div class="col-md-4 col-sm-12">
                                  ...
                                  <div class="col-md-4 col-sm-12">
                                    <div class='col-md-8 col-sm-4' style="padding-bottom: 7px;">
                                       <a href="add_clients.php?sale_type=2">
...
item_serial NOT IN (SELECT 
 ...
 AND item_serial NOT IN (SELECT 
  ...
  AND tbl_purchase_req_detail.recieved!='0' and tbl_purchase_req_detail.iemi='1' and tbl_purchase_req_detail.transfer='0' and tbl_purchase_req_detail.parent_id='$created_by'"; 
...
echo "<option value=$row1[item_id]".",$row1[barcode]".",$row1[item_serial]>$brand_name $row1[item_name] $barcode1 $item_serial1</option>"; 
 ...
 echo "</select>";
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    <div class="form-group">        
                                        <input type="text" name="form_fee" readonly=""  id="form_fee" class="form-control"   value="200" required="">
                                </div>
                              </div>
                                </div>
