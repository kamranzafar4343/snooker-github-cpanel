...
{
    $acode=substr($sub_child1, 0, -3);
    $where_acode='and left(acode, 6)="'.$acode.'"';
...
$(document).ready(function() {
    ...
    {
                text: '<span class="text-default"><i class="fa fa-file-excel-o"></i></span><span class="text"> Excel</span>',
                title: '<?php echo $c_name;?> (General Ledger)',
                extend: 'excelHtml5',
                messageTop: '<?php if($_POST){echo $aname;}?> \n Created at : (<?php echo date('m/d/Y h:i:s a', time());?>)',
                exportOptions: {
                    columns: [1, 2, 4, 5, 6, 7, 8]
                }
            }
