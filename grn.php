            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Create New Purchase GRN</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item">Purchase GRN</li>
                            <li class="breadcrumb-item active">Add Purchase GRN</li>
                        </ul>
                    </div>            
...
<?php
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                   <form action="operations/add_grn.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="body">
                            <div class="row clearfix"> 
                              <div class="col-md-4 col-sm-12">
                                ...
                                {
                                 $sql="SELECT * FROM tbl_purchase where bill_status='Pending' and iemi='0'"; 
                                }
                                else
                                {
                                 $sql="SELECT * FROM tbl_purchase where bill_status='Pending' and created_by='$userid' and iemi='0'"; 
...
var po=$('.po').val();
  ...
  $.ajax({
                url: "operations/gen_itemdetails.php",
                type: "POST",
                data: { 
                    po : po
                },
  ...
  function getTotal(row = null) {
    ...
    if(row) {
      ...
      if(qty=='')
      {
        ...
        $("#qty_rec_"+row).val(qty_rec);
        $("#qty_"+row).val(qty_rec);
