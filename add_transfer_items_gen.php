                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Add Transfer Items</li>
                        </ul>
                    </div>            
    ...
    $purchase_id='1';
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                   <form action="operations/add_transfer_gen.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="body">
                            <div class="row clearfix"> 
              ...
              ?>
                     <tr id="row_<?php echo $i;?>">
                       <td>
                                        ...
                                        $sql="SELECT * FROM tbl_items WHERE category IN (SELECT id FROM `tbl_cat` where cat_name NOT Like '%Mobile%')";  
