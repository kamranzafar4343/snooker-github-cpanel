            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Pending Payment (IEMI)</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item">Pending Payment</li>
                            <li class="breadcrumb-item active">Add Pending Payment (IEMI)</li>
                        </ul>
                    </div>            
...
<?php
              ...
              if(isset($_GET['edit_id']))
              {
                ...
                $sql=mysqli_query($conn, "SELECT branch_id, created_by  FROM users where user_id='$userid'");
                 ...
                 $sql3=mysqli_query($conn, "SELECT SUM(d_amount-c_amount) as cash_in_hand FROM `tbl_trans_detail` WHERE LEFT(acode, 6) IN('300100','100100') and parent_id='$parent_id'");
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                   <form action="operations/add_pending_po_payment.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="body">
                            <div class="row clearfix"> 
                              <div class="col-md-3 col-sm-12">
                                ...
                                <div class='col-md-8 col-sm-4' style="padding-top: 9px;padding-bottom: 4px;">
                                    ...
                                    <?php
                                      if($edit_id)
                                      {?>
                                      <input type="text" class="form-control po"  name="po" required="" readonly="" class="form-control"  value="<?php echo $edit_id; ?>">
                                      <?php }else{ 
                                      ?>
                                        <select class="form-control po"  name="po" onchange="get_detail();" >
                                          <option selected="" value="">-- Chose One --</option>
                                           <?php
                                            $sql="SELECT * FROM tbl_purchase where payment_status='Pending' and amount_remaining!='' and created_by='$userid' and iemi='1'"; 
                                            foreach ($conn->query($sql) as $row){
                                              $invoice="Purchase_".$row[purchase_id];
                                ...
                                <div class="col-md-3 col-sm-12">
                                    ...
                                    <div class="form-group">      
                                      ...
                                      <input type="hidden"  name="vendor" id="vendor" required="" readonly="" class="form-control" value="<?php echo $vendor; ?>">
                                      <?php }else{ 
                                      ?>
                                ...
                                <div class="col-md-8 col-sm-12" hidden="">
                                    ...
                                    <div class="form-group">        
                                        <textarea name="po_remarks"   readonly="" class="form-control"  row="1" ><?php echo $po_remarks; ?></textarea>
                                </div>
                              </div>
                                </div> 
                                <div class="col-md-12 col-sm-12" >
                                    ...
                                    <div class="form-group">        
                                        <textarea name="narration" required=""  class="form-control"  row="1" id="po_remarks"><?php echo $narration; ?></textarea>
                                </div>
                              </div>
                                </div>
                            </div><br>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group" id="discount1">
                   ...
                   <div class="form-group" id="cash_in_hand">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control calculate" id="cash_hand" readonly="" name="cash_in_hand" placeholder="Cash in hand" onkeyup="subAmount()" autocomplete="off" value="<?php echo round($cash_in_hand+$opening_bal); ?>">
                    </div>
                  </div>
                    
                  <div class="form-group" id="bank_id_field" style="display: none;" onchange="get_bank_balance();">
                  ...
                  <div class="form-group" id="check_no_field" style="display: none;">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="check_no" name="check_no" placeholder="Check No" autocomplete="off" value="">
                    </div>
                  </div>
                      <div class="form-group" id="discount1">
                    <label for="discount" class="col-sm-5 control-label">Pay Now</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control calculate" id="amount_payed" name="amount_payed" placeholder="Amount Payed" onkeyup="subAmount()" autocomplete="off" value="">
                    </div>
                  </div>
                  <div class="form-group" id="discount1">
...
$.ajax({
                                  method: "POST",
                                  url: "operations/get_detail_payment.php",
                                  data: {po:po},
                                  dataType: 'json',                 
                                })
...
var po=$('.po').val();
  ...
  $.ajax({
                url: "operations/get_itemdetail_payment.php",
                type: "POST",
                data: {
                    po : po
                },
...
// {
//   alert('Opps! Amount Recieved must be Equal to Amount Remaining..!');
...
var payment_method=$('#payment_method').val();
    if(payment_method=='Bank Payment')
    {
      ...
      if(cash_at_bank=='' || Number(cash_at_bank)<Number(amount_payed))
      {
        alert('Opps! Cash at Bank is Less than Amount Payed..! Add Cash at Bank first.');
        $('#amount_payed').focus();
        return false;
      }
    }
    else if(payment_method=='Cash Payment')
    {
      ...
      var amount_payed=parseFloat($('#amount_payed').val());
      var cash_in_hand=$('#cash_hand').val();
      ...
      if(cash_in_hand=='' || Number(cash_in_hand)<Number(amount_payed))
      {
        alert('Opps! Cash in Hand is Less than Amount Payed..! Add Cash first.');
        $('#amount_payed').focus();
        return false;
      }
    }
