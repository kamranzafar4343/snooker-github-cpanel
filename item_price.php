            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Items Price</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>                            
                            <li class="breadcrumb-item">Items</li>
                            <li class="breadcrumb-item active">Items Price</li>
                        </ul>
                    </div>            
  ...
  $("#danger-alert").hide();
    ...
    $("#danger-alert").fadeTo(4000, 500).slideUp(500, function() {
      $("#danger-alert").slideUp(500);
             ...
             ?>
             <div class="alert alert-custom alert-danger" role="alert" id="danger-alert3" style="display: none;">
                    <div class="alert-text"> <strong>Sorry ! </strong>Price must be greater than zero !</div>
            </div>
            <div class="alert alert-custom alert-danger" role="alert" id="danger-alert4" style="display: none;">
                    <div class="alert-text"> <strong>Sorry ! </strong>Opening quantity must be greater than zero !</div>
            </div>
            <div class="alert alert-custom alert-success" role="alert" id="success-alert3" style="display: none;">
                    <div class="alert-text"> <strong>Great ! </strong>Price Updated !</div>
            </div>
            <div class="alert alert-custom alert-success" role="alert" id="success-alert4" style="display: none;">
                    <div class="alert-text"> <strong>Great ! </strong>Stock Quantity Updated !</div>
            </div>
            <div class="alert alert-custom alert-danger" role="alert" id="success-alert5" style="display: none;">
                    <div class="alert-text"> <strong>Sorry ! </strong>Stock is empty or entered quantity is less than stock quantity !</div>
            </div>
...
<div class="datalist-wrapper">
    ...
    <div id="dataContainer" style="overflow-y: auto;">
      ...
      $query   = $conn->query("SELECT COUNT(*) as rowNum FROM tbl_items"); 
      ...
      $query = $conn->query("SELECT tbl_items.*, tbl_catagory.cat_name, tbl_cat.catagory_name FROM ((tbl_items INNER JOIN tbl_catagory ON tbl_items.brand_id = tbl_catagory.id) INNER JOIN tbl_cat ON tbl_items.category = tbl_cat.id) ORDER BY tbl_items.id ASC LIMIT $limit"); 
            if($query->num_rows > 0){ 
              $count=0; 
                                                      ...
                                                      <div class="body">
                                                        ...
                                                        <div class="row clearfix">
                                                            <div class="col-md-12 col-sm-12">
                                                                 <input type="text" class="form-control calculate " onchange="update_qty(<?php echo $count;?>, <?php echo $id;?>, <?php echo $total_qty;?>)" maxlength="7"  name="total_qty" id="qty_<?php echo $count;?>"  style="border-width: 3px; border-style: transparent;" value="<?php echo $total_qty;?>"></input>
                                                            </div>
                                                        </div>
                                                    </div>
                                                  <?php }else{?>
