                                ...
                                ?>
                                        ...
                                        <?php if($c_write=='1'){?>
                                            <td class="project-actions">
                                                ...
                                                <a href="operations/delete.php?sale_return_id=<?php echo $sale_id;?>" class="btn btn-sm btn-outline-danger js-sweetalert" title="Delete" data-type="confirm"><i class="icon-trash"></i></a>
                                            </td>
                                            <?php }?>
                                        </tr>
                                        <?php }?>
