            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Create New Purchase GRN (IEMI)</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item">Purchase GRN (IEMI)</li>
                            <li class="breadcrumb-item active">Add Purchase GRN (IEMI)</li>
                        </ul>
                    </div>            
                                      ...
                                      ?>
                                        <select class="form-control po"  name="po" onchange="get_detail();" >
                                          <option selected="" value="">-- Chose One --</option>
                                           <?php
                                            $sql="SELECT * FROM tbl_purchase where bill_status='Pending' and created_by='$userid' and iemi='1'"; 
                                            foreach ($conn->query($sql) as $row){
...
var po=$('.po').val();
  ...
  $.ajax({
                url: "operations/get_itemdetails.php",
                type: "POST",
                data: { 
                    po : po
                },
