                               ...
                               <div class="col-md-4 col-sm-12">
                                  ...
                                  <div class="col-md-4 col-sm-12">
                                    <div class='col-md-8 col-sm-4' style="padding-bottom: 7px;">
                                       <a href="add_clients.php?sale_type=1" >
  ...
  AND tbl_purchase_detail.qty_rec!='' and tbl_purchase_detail.transfer='0' and tbl_purchase_detail.iemi='0' and tbl_purchase_detail.parent_id='$created_by' "; 
                         ...
                         $return_query="SELECT * FROM tbl_purchase_detail INNER JOIN tbl_items ON tbl_purchase_detail.product = tbl_items.item_id   WHERE
                                 ...
                                 FROM
                                    tbl_purchase_detail
                                        INNER JOIN
                                  tbl_sale_return_detail  ON tbl_purchase_detail.pur_item_id = tbl_sale_return_detail.pur_item_id where tbl_sale_return_detail.sold='0' and tbl_sale_return_detail.returned='1' and tbl_sale_return_detail.iemi='0' and tbl_sale_return_detail.parent_id='$created_by')";
                                }
  else
  {
...
echo "<option value=$row1[item_id]".",$row1[barcode]".",$row1[item_serial]".",$row1[pur_item_id]>$brand_name $row1[item_name] $barcode1 $item_serial1 $row1[pur_item_id]</option>"; 
 ...
 echo "</select>";
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    <div class="form-group">        
                                       <select class="form-control select2"   required  name="sales_men" id="sales_men">
