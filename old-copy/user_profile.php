...
<style>
    .sticky-header {
        position: fixed;
        top: 0;
        background-color: white; /* Match your table header background */
    ...
    /* Ensure the table header cells match the table body cells */
    .sticky-header th {
        padding: 8px; /* Match your table cell padding */
        text-align: left; /* Match your table cell alignment */
    }
</style>
<?php
error_reporting(0);
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card profile-header">
                            <div class="body">
                                <div class="profile-image"> <img src="<?php if ($image != '') {
                                                                            echo $image;
                                                                        } else { ?> assets/images/userdefault.jpg<?php } ?>" class="rounded-circle" alt=""> </div>
                                <div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const header = document.querySelector(".table-container thead");
        const headerOffset = header.offsetTop;

        window.addEventListener("scroll", function () {
            if (window.pageYOffset > headerOffset) {
                header.classList.add("sticky-header");
                // Adjust the width of the sticky header to match the table
