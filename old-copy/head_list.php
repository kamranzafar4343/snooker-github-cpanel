...
?>
  ...
  <strong>Great ! </strong>Brand Deleted Successfully.
</div>
  ...
  <strong>Great!</strong> Head Added Succesfully.
</div>
              <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
  ...
  <strong>Opps!</strong>Failed to Add Head.
</div>
                            <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
             ...
             ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover js-basic-example dataTable table-custom table-striped m-b-0 c_list">
                                    <thead>
                                         <?php if($c_write=='1'){?>
                                        <tr>
                                            <th colspan="8" class="text-right"><a href="add_head.php" ><button type="button" class="btn btn-success">Add New</button></a></th>
                                        </tr>
                                        <?php }?>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php 
                        error_reporting(0);
                        $sql=mysqli_query($conn, "SELECT * FROM tbl_head ");
                        $count=0;
                        ...
                        ?>
                                        <tr>
                                            ...
                                            <td><span><?php echo $aname;?></span></td>
                                            <td>
                                          ...
                                          <?php if($c_write=='1'){?>
                                            <td>
                                                <a href="add_head.php?edit_id=<?php echo $id;?>"><button type="button" class="btn btn-sm btn-outline-secondary" title="Edit"><i class="fa fa-edit"></i></button></a>
                                                <a href="operations/delete.php?head_id=<?php echo $id;?>"><button type="button" class="btn btn-sm btn-outline-danger js-sweetalert" title="Delete" data-type="confirm"><i class="fa fa-trash-o"></i></button></a>
                                            </td>
                                            <?php }?>
                                        </tr>
<?php }?>
