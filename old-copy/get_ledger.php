            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Transaction History</h2>
                        <ul class="breadcrumb">
...
if($branch=='All' && $vendor_id=='All')
{
    $where_branch='';
    $where_ledger='where';
}
 if($vendor_id=='All'  && $branch!='All'){
...
if($vendor_id!='All'  && $branch=='All'){
        ...
        $where_branch='';
                            ...
                            if($len=='6')
                            {
                              ...
                              $where_ledger = "where left(acode,6) = $vendor_id and";  
                            }
                            else
                            {

                                $where_ledger = "where acode = $vendor_id and";
                            }

                }
else if($vendor_id!='All'  && $branch!='All')
{
   ...
   <div class="row clearfix" style="padding-right: calc(var(--bs-gutter-x) * 0.5);
    ...
    padding-left: calc(var(--bs-gutter-x) * 0.5);">
                <div class="col-lg-12 col-md-12">
                    <div class="card invoice1">                        
                        ...
                        ?>
                            ...
                            <hr> 
                              ...
                              <?php
                              $count=1;
                         $sql2 = "SELECT  * FROM tbl_trans_detail $where_ledger $where_branch  DATE(created_date) between '$f_date' and '$t_date' order by invoice_no desc ";
                  ...
                  $sql7=mysqli_query($conn, "SELECT  SUM(d_amount-c_amount) as trans_opening FROM `tbl_trans_detail` WHERE acode='$vendor_id' and  DATE(created_date) < '$f_date'");
