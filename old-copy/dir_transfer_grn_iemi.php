            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Create New GRN (IEMI)</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item">Direct Transfer</li> 
                            <li class="breadcrumb-item active">Add Direct Transfer GRN (IEMI)</li>
                        </ul>
                    </div>            
...
<?php
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                   <form action="operations/dir_transfer_grn.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="body">
                            <div class="row clearfix"> 
                                      ...
                                      ?>
                                        <select class="form-control po"  name="po" onchange="get_detail();" >
                                          <option selected="" value="">-- Chose One --</option>
                                           <?php
                                            $sql="SELECT * FROM tbl_purchase_req where stock_receive_status='Pending' and item_transfer!='' and iemi='1' and transfer_type='1' and created_by='$userid'"; 
                                            foreach ($conn->query($sql) as $row){
...
var po=$('.po').val();
  ...
  $.ajax({
                url: "operations/add_req_grn.php",
                type: "POST",
                data: { 
                    po : po
                },
