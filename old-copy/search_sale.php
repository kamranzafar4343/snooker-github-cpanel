...
<?php
    ...
    $("#danger-alert").fadeTo(4000, 500).slideUp(500, function() {
      $("#danger-alert").slideUp(500);
              ...
              <?php
                         ...
                         <form  action="single_sale.php" id="form1" method="post" enctype="multipart/form-data">
                        <div class="body">
                            <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
  ...
  <strong>Sorry ! </strong>From Date Should be Smaller Then To Date!.
    ...
    <input type="date" class="form-control" name="f_date" id="f_date" placeholder="Item Name *" required="" value="<?php echo date('Y-m-d'); ?>">
                  ...
                  <div class="row clearfix">
                                    <div class="col-md-2 text-right">
                                         <label for="description"> Customer Type </label>
                                  </div>
                                <div class="col-md-5 col-sm-12">
                                    <div class="form-group">
                                    <select class="form-control " name="customer_id" id='customer_id' onchange="get_customer()" >
                                        
         <option value="Credit">Lease</option>
...
if(Date.parse(from) > Date.parse(to)){
   ...
   $("$f_date").focus();
    ...
    var customer_id = $('#customer_id').val();
      ...
      $.ajax({
                  method: "POST",
                  url: "operations/get_customer.php",
                   ...
                   alert(len);
                     ...
                     $("#customers").empty();
                        for( var i = 0; i<len; i++){
                            ...
                            $("#customers").append("<option value='"+sale_id+"'>"+customer_name+"</option>");
