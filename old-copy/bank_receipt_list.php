            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Bank Receipt List</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>                            
                            <li class="breadcrumb-item">Bank Receipt</li>
                            <li class="breadcrumb-item active">Bank Receipt List</li>
                        </ul>
                    </div>            
              ...
              ?>
                        ...
                        <div class="body project_report">
                          ...
                          <div class=" text-right">
                           ...
                           <a href="bank_receipt.php">
                          <button  class="btn btn-info m-b-15" type="button">
                                <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Bank Receipt
                            </button>
                          </a>
                          ...
                          <?php }?>
                            <div class="table-responsive">
                                ...
                                $count=0;
                                    ...
                                    // $d_id=$_GET['d_id'];
                                $sql = mysqli_query($conn,"SELECT * FROM tbl_payment where payment_type='Bank_Receipt' order by id asc");
                                ...
                                ?>
                                        ...
                                        <?php if($c_write=='1'){?>
                                            <td class="project-actions">
                                                ...
                                                <a href="bank_receipt.php?edit_id=<?php echo $id;?>" class="btn btn-sm btn-outline-success"><i class="icon-pencil"></i></a>
                                                <a href="operations/delete.php?bank_receipt=<?php echo $id;?>" class="btn btn-sm btn-outline-danger js-sweetalert" title="Delete" data-type="confirm"><i class="icon-trash"></i></a>
                                            </td>
                                            <?php }?>
                                        </tr>
                                        <?php }?>
