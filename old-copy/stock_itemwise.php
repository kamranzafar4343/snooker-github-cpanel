            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Stock Item Wise Report</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>                            
                            <li class="breadcrumb-item"> Stock Item Wise Report</li>
                        ...
                        <div class="row">
                            <div class="invoice-top clearfix col-md-12">
                                ...
                                <div class="info text-center col-md-12" style="margin-top: 1%;" >
                                    ...
                                    <h3  class="text-center">Stock Item Wise Report</h3>
                         ...
                         <form  action="stock_itemwise.php" method="post" enctype="multipart/form-data" id='form1'>
                        <div class="body">
                                    ...
                                    <tbody id="stock">
                                      ...
                                      ?>  
                                                        <tr>
                                                            ...
                                                            <td><h7 class="m-b-0 m-t-6"><?php echo $pur_item_id." ".$barcode;?></h7></td>
                                                            <td><h7 class="m-b-0 m-t-6"><?php echo $item_serial;?></h7></td>
...
$(document).ready(function() {
      ...
      buttons: [
          ...
          extend: 'pdf',
          text: 'PDF',
          title: '<?php echo $c_name;?> (Stock Report Item Wise)',
