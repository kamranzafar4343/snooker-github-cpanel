...
if($branch=='All' && $account=='All')
{
    $where_branch='';
    $where_acode="where LEFT(acode,6) in('500200', '500100') and ";
}
 if($account=='All'  && $branch!='All'){

    $username = 'All';
    $where_acode = "where LEFT(acode,6) in('500200', '500100') and ";
    $where_branch='parent_id="'.$branch.'" and';
...
else if($account!='All'  && $branch!='All')
{
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card invoice1">                        
                        ...
                        <div class="row">
                         ...
                         <form  action="expense_report.php" method="post" enctype="multipart/form-data" id='form1'>
                        <div class="body">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card invoice1">                        
                        ...
                        ?>
                         ...
                         $sql2 = "SELECT  * FROM tbl_trans_detail $where_acode $where_branch  DATE(created_date) between '$f_date' and '$t_date' order by invoice_no desc ";
                        ...
                        $acode=$ndata['acode'];
                        $trans_id=$ndata['trans_id'];
                        $created_date = $ndata['created_date'];
                  ...
                  $sql4=mysqli_query($conn, "SELECT  opening_bal FROM `tbl_account` WHERE Left(acode,6)='$account'");
                  ...
                  if($opening_bal=='')
                  {
                    ...
                    $sql4=mysqli_query($conn, "SELECT  opening_bal FROM `tbl_account_lv2` WHERE acode='$account'");

                  $data4=mysqli_fetch_assoc($sql4);
                  $opening_bal = $data4['opening_bal'];
                  }
                  $sql7=mysqli_query($conn, "SELECT  SUM(d_amount-c_amount) as trans_opening FROM `tbl_trans_detail` WHERE acode='$account' and  DATE(created_date) < '$f_date'");

                  $data4=mysqli_fetch_assoc($sql7);
                  $trans_opening = $data4['trans_opening'];
                  $opening=$opening_bal+$trans_opening;
                  $cash_now=$opening+($tot_damt-$tot_camt);
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-md-6 text-right">
                                            ...
                                            <h5 class="m-b-0  m-t-14">Opening : <?php echo round($opening); ?></h5>                                     
