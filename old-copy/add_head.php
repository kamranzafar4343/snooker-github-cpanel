        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Add Head</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>                            
                            <li class="breadcrumb-item">Head List</li>
            ...
            <div class="row clearfix">
              ...
              if(isset($_GET['edit_id']))
              {
                ...
                $sql=mysqli_query($conn, "SELECT * FROM tbl_head where id=$edit_id");
              ...
              ?>
                        ...
                        <div class="body">
                            ...
                            <button type="submit" class="btn btn-primary" name="add_head">Add</button>
