              ...
              ?>
                            ...
                            <div class="row clearfix">
                                  ...
                                  <div class="col-md-4 col-sm-12">
                                    ...
                                    <div class='col-md-12 col-sm-4'>
                                    <div class="form-group">        
                                    <select class=" form-control select_group"  id="sub_child1" name='sub_child1' style="width: 100%;">
                                    ...
                                    <div class='col-md-12 col-sm-4'>
                                    <div class="form-group">        
                                    <input type="text" name="aname" id="aname" required="" class="form-control calculate" placeholder="Sub Head Lv 2 *" value="<?php echo $aname1;?>">
                                    <input type="hidden" class="form-control" name="subchild_id" value="<?php echo $subchild_id; ?>">
                                  </div>
                                </div>
                                </div>
                          
                            <div class='text-center' style="padding-left: 30px;">
                            <button type="submit" id='submit' name="subhead_lv2" class="btn btn-primary">Create</button>
                            ...
                            <form  action="operations/accounts.php" method="post" enctype="multipart/form-data">
                              <div class="modal-content">
                                  <div class="modal-header">
                                      <h4 class="title" id="largeModalLabel">Add Head</h4>
                                  </div>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="aname" placeholder="Head Name *" required="" value="<?php echo $aname;?>">
                                        <input type="hidden" class="form-control" name="head_id" value="<?php echo $head_id; ?>">
                                  ...
                                  <div class="modal-footer">
                                      <button type="submit" class="btn btn-primary" name="add_head">SAVE CHANGES</button>
                      ...
                      <div class="modal fade" id="largeModal1" tabindex="-1" role="dialog">
                          <div class="modal-dialog modal-lg" role="document">
                            <form  action="operations/accounts.php" method="post" enctype="multipart/form-data">
                              <div class="modal-content">
                                  <div class="modal-header">
                                      <h4 class="title" id="largeModalLabel">Add Sub Head Lv 1</h4>
                                  </div>
                                  <div class="modal-body"> 
                                    <div class="row clearfix ">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <label>Head Name *</label>
                                    <div class="form-group">
                                       <select class="form-control select_group" name="parent_code" style="width: 100%">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control calculate" name="aname" placeholder="Sub Head Name *" required="" value="<?php echo $aname;?>">
                                        <input type="hidden" class="form-control" name="subhead_id" value="<?php echo $subhead_id; ?>">
                                    </div>
                                </div>
...
getsublev();
    ...
    var parent_code = $('#parent_code').val();
      ...
      $.ajax({
                  method: "POST",
                  url: "operations/get_sublevel_chart.php",
