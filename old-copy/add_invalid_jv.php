            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Complete JV Voucher</h2>
                        <ul class="breadcrumb">
                              ...
                              <div class="col-md-4 col-sm-12">
                                ...
                                <div class='col-md-8 col-sm-4' style="padding-top: 9px;padding-bottom: 4px;">
                                    ...
                                    ?>  
                                        ...
                                        <input type="text" name="account" readonly="" id="remarks" class="form-control" value="<?php echo $aname;?>"> 
                                ...
                                <div class='col-md-8 col-sm-4' style="padding-top: 9px;padding-bottom: 4px;">
                                    ...
                                    <div class="form-group">        
                                         <input type="text" name="amount" readonly="" id="amount" class="form-control" value="<?php echo $debit;?>">
                                </div>
                              </div>
                                </div> 
                                <div class="col-md-4 col-sm-12">
...
echo "<option value=$row[acode] selected>$row[aname]</option>"; 
 ...
 ?>
                        ...
                        <td>
                          <input type="text" name="debit[]" id="debit_<?php echo $i;?>" class="form-control calculate" required  autocomplete="off" onkeyup="getTotal(<?php echo $i;?>)" value="<?php echo $debit;?>">

                          
                        </td>
                        <td ><input type="text" name="credit[]" id="credit_<?php echo $i;?>" readonly=""  class="form-control calculate"  autocomplete="off" value="0" ></td>
                   ...
                   <?php } } $i=2;?>
                       ...
                       <td>
                        ...
                        <td hidden><input type="text" name="debit[]" id="debit_<?php echo $i;?>"  class="form-control calculate" value="0" required autocomplete="off" onkeyup="change_credit();" ></td>
                        <td ><input type="text" name="credit[]" id="credit_<?php echo $i;?>" readonly=""  class="form-control calculate"  autocomplete="off" value="<?php echo $debit;?>" ></td>
