            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Create New Purchase Req (IEMI)</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item">Purchase</li>
                            <li class="breadcrumb-item active">Add Purchase Req (IEMI)</li>
                        </ul>
                    </div>            
  ...
  {  
    $purchase_id='1';
                            ...
                            <div class="row clearfix"> 
                              <div class="col-md-4 col-sm-12">
                                ...
                                <div class="col-md-8 col-sm-12">
                                    ...
                                    <div class="form-group">        
                                        <textarea name="po_remarks"  class="form-control" required="" row="1"><?php echo $po_remarks; ?></textarea>
                                </div>
                              </div>
                                </div> 
          ...
          if($edit_id!='')
          {
                ...
                $lsql=mysqli_query($conn, "SELECT * FROM tbl_purchase_req_detail where purchase_req_id=$edit_id");
                $i=0;
