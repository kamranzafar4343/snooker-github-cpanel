...
?>
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
  ...
  <strong>Sorry  !</strong> Purchase can not be Deleted, Return same amount of items first .
</div>
                            <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
              ...
              ?>
                        <div class="body project_report">
                         ...
                         <!--  <a href="purchase_add.php">
                          ...
                          <button  class="btn btn-warning m-b-15" type="button">
                                <i class="fa fa-usd" aria-hidden="true"></i> Add Pending Payment
                            </button>
                          </a>
                          ...
                          <?php }?>
                            <div class="table-responsive">
                                ...
                                $count=0;
                                    ...
                                    // $d_id=$_GET['d_id'];
                                $sql = mysqli_query($conn,"SELECT * FROM tbl_purchase where created_by='$userid'");
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td class="project-actions">
                                                ...
                                                <a href="add_purchase_po.php?edit_id=<?php echo $purchase_id;?>" class="btn btn-sm btn-outline-success"><i class="icon-pencil"></i></a>
