                                                        ...
                                                        <div class="row clearfix">
                                                          <div class="col-md-12 col-sm-12">
                                                              <label>Advance Date</label>
                                                                 <input type="date" class="form-control"  name="created_date" id="created_date" <?php if($userid!=1){?>readonly=""<?php }?>  style="border-width: 3px; border-style: transparent;" value="<?php echo $date_now;?>"></input>
