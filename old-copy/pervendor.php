            ...
            <div class="row clearfix" >
               ...
               // echo "string";
                        ...
                        $vendornamee = $dataa['username'];   ?>  
                            ...
                            <span > <b> DATE : </b> <?php $created_date=$ndata['created_date']; $newDate = date("d-m-Y H:i a", strtotime($created_date));
  echo $newDate;?>
                       </span>
                     </div> </div> 
                            <hr>  
...
$count++;
  ?>
                            ...
                            <td><?php echo $catagory_name." ".$itemname;?></td>
                            <td><?php echo $qty;?></td>
                            <td><?php echo $rate;?></td>
      ...
      buttons: [
        {
          ...
          text: '<?php echo $c_name;?>',
           title: '<?php echo $c_name;?> (PO Items Report) for PO#<?php echo $purchase_id; ?>',
