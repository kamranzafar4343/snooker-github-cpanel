...
<?php
              ...
              if(isset($_GET['sale_id']))
              {
                ...
                $data=mysqli_fetch_assoc($sql);
                    ...
                    $sql=mysqli_query($conn, "SELECT * FROM tbl_account_lv2 where acode=$customer_name");
                    $data=mysqli_fetch_assoc($sql);
                    $customername=$data['aname'];
  ...
  <?php 
            ...
            <div class="row clearfix" >
                        ...
                        <div class="body">
                            <div class="invoice-top clearfix">
                                ...
                                <div class="title">
                                    ...
                                    <h5>Customer  :</b> <?php echo $customername;?></h5>
                                </div>
                            </div>
              ...
              ?> 
                              ...
                              <td><?php echo $cat_name." ".$productname;?></td>
                                            ...
                                            <?php }?>
                                               ...
                                               <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table-danger"><strong><?php echo $fixed_discount;?></strong></td>
                                                </tr>
                                                <tr>
                                                    <td style="border: none;"></td>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td style="border: none;"></td>
                                                    <td style="border: none;"></td>
                                                    <td class="table-danger"><strong>Tax</strong></td>
                                                    <td class="table-danger"><strong><?php echo $tax;?> %</strong></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border: none;"></td>
                                                    <td style="border: none;"></td>
                                                    <td class="table-warning"><strong>Amount Total</strong></td>
                                                    <td class="table-warning"><strong><?php echo $gross_amount;?></strong></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border: none;"></td>
                                                    <td style="border: none;"></td>
                                                    <td class="table-warning"><strong>Amount Recieved</strong></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border: none;"></td>
                                                    <td style="border: none;"></td>
                                                    <td class="table-warning"><strong>Amount Returned</strong></td>
                                                    <td class="table-warning"><strong><?php echo $amount_return;?></strong></td>
                                                </tr>
                                            </tbody>                                            
                                        </table>
                                    </div>
                         ...
                         <!--    <div class="row clearfix">
                            ...
                            <div class="row clearfix nodisplay">
                                <div class="col-md-12 text-center">
                                    <a href="sale_list.php"><button type="button"  class="btn btn-danger">Back</button></a>
