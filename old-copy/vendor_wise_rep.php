  ...
  <strong>Sorry ! </strong>From Date Should be Smaller Then To Date!.
    ...
    <input type="date" class="form-control" name="f_date" id="f_date" placeholder="Item Name *" required="" value="<?php echo date('Y-m-d'); ?>">
                              ...
                              <div class="col-md-5 ">
                                    ...
                                    <div class="form-group">
                                <input type="date" class="form-control" id="t_date" name="t_date" placeholder="Item Name *" required="" value="<?php echo date('Y-m-d'); ?>">
                                    </div>
                                </div>
                            </div>
                                 <div class="row clearfix">
                          ...
                          <div style="margin-right: 25%;" class="text-center">
                            <button style="width:25%; " type="submit" class="btn btn-primary" name="purchase_rep" onclick="check()" target='_blank'>Search</button>
                        </div>
                    </form>
                    </div>
                </div>
