                    ...
                    data-tokens='" . $table['table_name'] . "'>"
                      ...
                      <div class="col-md-2">
                        <div class="form-group" style="margin-top: 28px;">
                          <button type="button" class="btn btn-primary" onclick="searchFilter(0)">
                            Search
                          </button>
                        </div>
                      </div>
                      ...
                      <div class="col-md-3">
                        <div class="form-group" style="margin-top: 25px; margin-left: 150px;">
                          <button id="bulkComplete" class="btn btn-success" onclick="completeSelected()">
              ...
              <div class="search-panel mt-0">
                <div class="form-row align-items-end">
                  <div class="form-group col-md-1 mb-0">
                    ...
                    <select class="form-control form-control-sm" onchange="pageFilter();" id="pageFilter">
                      <option>20</option>
                      <option>40</option>
                      <option>60</option>
                      <option>80</option>
    ...
    $(document).ready(function() {
      ...
      function initializeSelect2() {
        $(".customer_details").select2({
          ...
          dropdownParent: $("#customerEditModal") // This ensures dropdown shows correctly in modal
        });
      }
