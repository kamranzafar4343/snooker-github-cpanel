...
<?php
              ...
              if(isset($_GET['purchase_id']))
              {
                ...
                $sql=mysqli_query($conn, "SELECT * FROM tbl_purchase where purchase_id=$purchase_id");
                ...
                $data=mysqli_fetch_assoc($sql);
                        ...
                        $query1 = mysqli_query($conn,"SELECT * FROM tbl_vendors where vendor_id=$vendor_id"); 
                                   ...
                                   $customer_phone=$cdata['mobile_no'];
...
<!-- <body onload="window.print();"> -->
 <?php 
            ...
            <div class="row clearfix" >
                        ...
                        <div class="body">
                            <div class="invoice-top clearfix">
                                ...
                                <div class="title">
                                    ...
                                    <p>Created Date : <?php echo $invoice_date;?></p>
                ...
                $count=0;
                $lsql=mysqli_query($conn, "SELECT * FROM tbl_purchase_detail where purchase_id=$purchase_id");
