            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Local Purchase Payment</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item">Local Purchase</li>
                            <li class="breadcrumb-item active">Add Local Purchase Payment</li>
                        </ul>
                    </div>            
...
<?php
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                   <form action="operations/add_loc_payment.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="body">
                            <div class="row clearfix"> 
                                      ...
                                      ?>
                                        <select class="form-control po"  name="po" onchange="get_detail();" >
                                          <option selected="" value="">-- Chose One --</option>
                                           <?php
                                            $sql="SELECT * FROM  tbl_single_purchase where payment_status='Pending' and bill_status='Completed' and amount_payed='0' and created_by='$userid' and iemi='0'"; 
                                            foreach ($conn->query($sql) as $row){
                  ...
                  <thead style="background-color: orange;">
                    <tr>
                      ...
                      <th style="width:20%" hidden>Remove</th>
                    </tr>
                  </thead>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="gross_amount" name="gross_amount" readonly="" autocomplete="off" tabindex="-1" value="<?php echo $gross_amount;?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control calculate" id="discount" name="discount" placeholder="Discount" readonly="" tabindex="-1" onkeyup="subAmount()" autocomplete="off" value="<?php echo $discount;?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="net_amount" class="col-sm-5 control-label">Net Amount</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="net_amount" name="net_amount" autocomplete="off" readonly="" tabindex="-1" value="<?php echo $net_amount;?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group" id="discount1">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control calculate" tabindex="-1" tabindex="-1" id="amount_remaining" name="amount_remaining"  autocomplete="off" readonly="" value="<?php echo $amount_remaining;?>">
                    </div>
                  </div>
...
var po=$('.po').val();
  ...
  $.ajax({
                url: "operations/get_local_item_payment.php",
                type: "POST",
                data: {
                    po : po
                },
...
var item_total=parseFloat($('#item_total').val());
 if(item_recieved==0 || item_recieved=='' || isNaN(item_recieved))
{
  alert('Opps! Received Item is Missing..!');
    $('#item_recieved').val('');
    $('#item_recieved').focus();
 ...
 ?>'
  ...
  function subAmount() {
    ...
    for(x = 0; x < tableProductLength; x++) {
      ...
      totalRecQty = Number(totalRecQty) + Number($("#qty_"+count).val());
