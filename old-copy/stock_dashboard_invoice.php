...
<?php
              ...
              if(isset($_GET['purchase_req_id']))
              {
                ...
                $data=mysqli_fetch_assoc($sql);
                        ...
                        $location = $data['trans_parent_id'];
                        $from_location = $data['parent_id'];
                        ...
                        $query = mysqli_query($conn,"SELECT user_name,created_by FROM users where user_id=$from_location"); 
                        ...
                        $query = mysqli_query($conn,"SELECT invoice_no,created_date FROM tbl_purchase_req where purchase_req_id=$purchase_req_id"); 
                                   
                                   $zdata = mysqli_fetch_assoc($query) ;
                                   $invoice_no=$zdata['invoice_no'];
                    ...
                    <div class="card invoice1">                        
                        <div class="body">
                            <div class="invoice-top clearfix">
                                ...
                                <div class="title">
                                    <h4>Transfer # <?php echo $invoice_no;?></h4>
                                    <p>Created Date : <?php echo $date;?>  <?php echo $time;?></p>
                                    </div>
                            </div>
                            <hr>
