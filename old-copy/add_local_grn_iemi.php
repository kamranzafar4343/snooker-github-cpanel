                                      ...
                                      ?>
                                        <select class="form-control po"  name="po" onchange="get_detail();" >
                                          <option selected="" value="">-- Chose One --</option>
                                           <?php
                                            $sql="SELECT * FROM tbl_single_purchase where bill_status='Pending' and created_by='$userid' and iemi='1'"; 
                                            foreach ($conn->query($sql) as $row){
...
var po=$('.po').val();
  ...
  $.ajax({
                url: "operations/local_item_iemi.php",
                type: "POST",
                data: { 
                    po : po
                },
...
if(errorCounterDupInput==1)
{
    ...
    alert('Product IEMI Already Added..!');
