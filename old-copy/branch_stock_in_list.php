            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Branch Stock In List</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>                            
                            <li class="breadcrumb-item">Branch Stock In</li>
                            <li class="breadcrumb-item active">Branch Stock In List</li>
                        </ul>
                    </div>            
    ...
    <?php
              ...
              ?>
                        <div class="body project_report">
                          ...
                          <a href="branch_stock_in_iemi.php">
                          <button  class="btn btn-info m-b-15" type="button">
                                <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Stock In (IEMI)
                            </button>
                          </a>
                          <a href="branch_stock_in.php">
                          <button  class="btn btn-warning m-b-15" type="button">
                                <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Stock In
                            </button>
                          </a>
                            ...
                            <div class="table-responsive">
                                ...
                                $count=0;
                                    ...
                                    // $d_id=$_GET['d_id'];
                                $sql = mysqli_query($conn,"SELECT * FROM tbl_purchase_req where location='$userid' and transfer_type='2'");
                                            ...
                                            <td class="project-actions">
                                               ...
                                               <!--   <?php if($U=='1'){?>
                                                ...
                                                <a href="branch_out_invoice.php?purchase_req_id=<?php echo $purchase_req_id;?>" class="btn btn-sm btn-outline-info js-sweetalert" title="View" data-type="confirm"><i class="icon-eye"></i></a>
                                                 <?php if($D=='1'){?>
                                                    <a  <?php echo $display;?> href="operations/delete.php?branch_in_id=<?php echo $purchase_req_id;?>"  <?php echo $display;?> class="btn btn-sm btn-outline-danger js-sweetalert" title="Delete" onclick="return confirm('Are you sure want to delete');"><i class="icon-trash"></i>
