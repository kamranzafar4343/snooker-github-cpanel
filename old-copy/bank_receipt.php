            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Create New Bank Receipt</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item">Bank Receipt</li>
                            <li class="breadcrumb-item active">Add Bank Receipt</li>
                        </ul>
                    </div>            
...
<?php
              ...
              if(isset($_GET['edit_id']))
              {
                ...
                $data=mysqli_fetch_assoc($sql);
                        ...
                        $sql2=mysqli_query($conn, "SELECT bank_id, check_no  FROM `tbl_trans` WHERE invoice_no='Bank_Receipt_".$edit_id."'");
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                   <form action="operations/bank_receipt.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="body">
                            <div class="row clearfix"> 
                  ...
                  <thead style="background-color: orange;">
                   ...
                   <tbody>
                    ...
                    <?php
              $acc_query="SELECT * FROM `tbl_account_lv2` WHERE LEFT(acode, 6) IN('100200', '300100')";
          if($edit_id!='')
          {


                $lsql=mysqli_query($conn, "SELECT * FROM tbl_trans_detail where invoice_no='Bank_Receipt_".$edit_id."' and d_amount='0'");
                $i=0;
