            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Create New Bank Payment</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item">Bank Payment</li>
                            <li class="breadcrumb-item active">Add Bank Payment</li>
                        </ul>
                    </div>            
...
<?php
              ...
              if(isset($_GET['edit_id']))
              {
                ...
                $data=mysqli_fetch_assoc($sql);
                        ...
                        $sql2=mysqli_query($conn, "SELECT bank_id, check_no  FROM `tbl_trans` WHERE invoice_no='Bank_Payment_".$edit_id."'");

                        $data2=mysqli_fetch_assoc($sql2);
                        $bank_id = $data2['bank_id'];
                        $check_no = $data2['check_no'];
              }

               $sql3=mysqli_query($conn, "SELECT SUM(d_amount-c_amount) as cash_at_bank FROM `tbl_trans_detail` WHERE LEFT(acode, 6) IN ('100700')");
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                   <form action="operations/bank_payment.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="body">
                            <div class="row clearfix"> 
                              <div class="col-md-4 col-sm-12">
                                ...
                                <div class="col-md-4 col-sm-12">
                                 ...
                                 <div class="col-md-4 col-sm-12">
                                    ...
                                    <div class="form-group">        
                                        <input type="text" name="cash_at_bank" id="cash_at_bank" required="" readonly="" class="form-control" placeholder="Cash at Bank"  value="<?php echo $cash_at_bank; ?>">
                                ...
                                <div class="col-md-6 col-sm-12">
                                 ...
                                 <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">        
                                       <input type="text" class="form-control" id="check_no" name="check_no" required="" placeholder="Check No" autocomplete="off" value="<?php echo $check_no;?>">
                  ...
                  <thead style="background-color: orange;">
                   ...
                   <tbody>
                    ...
                    <?php
              $acc_query="SELECT * FROM `tbl_account_lv2` WHERE LEFT(acode, 6) IN('200200','500200')";
          if($edit_id!='')
          {


                $lsql=mysqli_query($conn, "SELECT * FROM tbl_trans_detail where invoice_no='Bank_Payment_".$edit_id."' and c_amount='0'");
                $i=0;
...
var cash_at_bank=$("#cash_at_bank").val();
