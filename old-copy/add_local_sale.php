                              ...
                              <div class="col-md-4 col-sm-12">
                                ...
                                <div class="col-md-4 col-sm-12">
                                     ...
                                     <div class='col-md-8 col-sm-4' style="padding-bottom: 7px;">
                                       <a href="add_clients.php?sale_type=7">
  ...
  AND tbl_single_purchase_detail.qty_rec!='' and tbl_single_purchase_detail.iemi='0' and tbl_single_purchase_detail.parent_id='$created_by' "; 
                         ...
                         $return_query="SELECT * FROM tbl_single_purchase_detail INNER JOIN tbl_items ON tbl_single_purchase_detail.product = tbl_items.item_id   WHERE
                                 ...
                                 FROM
                                    tbl_single_purchase_detail
                                        INNER JOIN
                                  tbl_sale_return_detail  ON tbl_single_purchase_detail.pur_item_id = tbl_sale_return_detail.pur_item_id where tbl_sale_return_detail.sold='0' and tbl_sale_return_detail.returned='1') and tbl_single_purchase_detail.parent_id='$created_by'";
}
else
{
  ...
  AND tbl_single_purchase_detail.qty_rec!='' and tbl_single_purchase_detail.iemi='0'  and tbl_single_purchase_detail.created_by='$userid' "; 
                         ...
                         $return_query="SELECT * FROM tbl_single_purchase_detail INNER JOIN tbl_items ON tbl_single_purchase_detail.product = tbl_items.item_id   WHERE
                                 ...
                                 FROM
                                    tbl_single_purchase_detail
                                        INNER JOIN
                                  tbl_sale_return_detail  ON tbl_single_purchase_detail.pur_item_id = tbl_sale_return_detail.pur_item_id where tbl_sale_return_detail.sold='0' and tbl_sale_return_detail.returned='1') and tbl_single_purchase_detail.created_by='$userid'";
...
echo "<option value=$row[item_id]"." $row[barcode] "." $row[item_serial] ".",$row[pur_item_id] selected>$brand_name $row[item_name] "." $row[barcode] "." $row[item_serial]"."$row[pur_item_id]</option>"; 
 ...
 ?>
                        ...
                        <td><input type="text" readonly name="qty[]" id="qty_<?php echo $i;?>" class="form-control calculate" onkeyup="getTotal(<?php echo $i;?>)" value="<?php echo $qty;?>"></td>
                        <td>
...
echo "<option value=$row1[item_id]".",$row1[barcode]".",$row1[item_serial]".",$row1[pur_item_id]>$brand_name $row1[item_name] $barcode1 $item_serial1 $row1[pur_item_id]</option>"; 
 ...
 ?>
                        ...
                        <td><input type="text" name="stock_qty[]" id="stock_qty_<?php echo $i;?>"  class="form-control calculate" readonly onkeyup="getTotal(<?php echo $i;?>)" value=""></td>
                        <td><input type="text" readonly name="qty[]" id="qty_<?php echo $i;?>"  class="form-control calculate" onchange="getTotal(<?php echo $i;?>)" ></td>
                        <td>
...
$(".submit").click(function() {
 ...
 if(sale_type=='Cash')
 {
    ...
    if(amount_recieved<net_amount)
      {
        alert('Opps! Amount Recieved must be Equal to Total amount..!');
          $('#amount_recieved').val('');
...
echo "<option value=$row[item_id]".",$row[barcode]".",$row[item_serial]".",$row[pur_item_id]>$brand_name $row[item_name] $barcode $item_serial $row[pur_item_id]</option>"; 
 ...
 ?>'
  html += '</select>'+
                    ...
                    '<td><input type="number" readonly name="qty[]" id="qty_'+row_id+'"  readonly required class="form-control" onchange="getTotal('+row_id+')"></td>'+
...
$.ajax({
  ...
  function get_stock_qty()
 {
  ...
  var dataString = 'itemid='+ itemid;
    ...
    $.ajax({
type: "POST",
url: "operations/get_stock_local.php",
data: dataString,
