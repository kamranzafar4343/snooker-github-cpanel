            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Create New Sale Return (IEMI)</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item">Sale</li>
                            <li class="breadcrumb-item active">Add Sale Return (IEMI)</li>
                        </ul>
                    </div>            
                              ...
                              <div class="col-md-3 col-sm-12">
                                ...
                                <div class='col-md-8 col-sm-4' style="padding-top: 9px;padding-bottom: 4px;">
                                    ...
                                    <?php
                                      ...
                                      <?php }else{ 
                                      ?>
                                        <select class="form-control bill_no"  name="bill_no" onchange="get_detail();" >
                                ...
                                {
                                  $sql="SELECT * FROM tbl_sale where iemi='1'  and created_by='$userid'"; 
                                }
                                else
                                {
                                  $sql="SELECT * FROM tbl_sale where iemi='1'  and created_by='$userid'";
                                            ...
                                            $sql1="SELECT * FROM tbl_sale_detail where returned='0'  and sale_id='$sale_id'"; 
                                        
                                                }
                                            foreach ($conn->query($sql) as $row){
                                            
                                            echo "<option value=$row[sale_id]>$invoice $username $usercnic $row[created_date]</option>"; 
...
var bill_no=$('.bill_no').val();
  ...
  $.ajax({
                url: "operations/cash_return_iemi.php",
                type: "POST",
                data: {
                    bill_no : bill_no
                },
