...
error_reporting(0);
    ...
    $brand_name=$value2['cat_name'];
      ...
      echo '                
                        ...
                        <td hidden><input type="text" readonly name="item_serial[]" id="item_serial_'.$i.'" class="form-control item_serial"  value="'.$item_serial.'" ></td>
                        <td><input type="text" readonly name="barcode[]"  id="barcode_'.$i.'" class="form-control barcode"  value="'.$barcode.'"></td>
                        <td hidden><input type="text" readonly name="pur_item_id[]"  id="pur_item_id_'.$i.'" class="form-control pur_item_id"  value="'.$pur_item_id.'"></td>
