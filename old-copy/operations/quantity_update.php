...
$brand_name=$value2['catagory_name'];
     	      ...
     	      echo ' 
                    <tr id="row_'.$i.'">
                        <td><input type="text" name="product_name[]" id="product_name_'.$i.'" required readonly class="form-control" tabindex="-1" value="'.$brand_name." ".$item_name.'"><input type="hidden" name="product[]" id="product_'.$i.'" required readonly class="form-control item_id" value="'.$item_id.'">
                        </td>
                    	...
                    	<td><input type="text" tabindex="-1" name="rate[]" id="rate_'.$i.'"  class="form-control" value="'.$sale_rate.'" onchange="getTotal('.$i.', '.$temp_id.')"></td>
                    	<td><input type="text" name="amount[]" id="amount_'.$i.'" class="form-control" readonly tabindex="-1" value="'.$amount.'"></td>
