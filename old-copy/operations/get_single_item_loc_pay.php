...
error_reporting(0);
     ...
     while($row = mysqli_fetch_array($result) ){
      ...
      echo '                
                        ...
                        <td hidden><input type="text"  readonly="" name="pur_item_id[]" id="pur_item_id_'.$i.'" tabindex="-1" class="form-control" required  value="'.$pur_item_id.'"></td>
                        <td><input type="text"  readonly="" name="barcode[]" id="barcode_'.$i.'" tabindex="-1" class="form-control" required value="'.$barcode.'"></td>
                        <td><input type="text"  readonly=""  name="qty_rec[]" id="qty_rec_'.$i.'" class="form-control calculate" required onchange="getTotal('.$i.')" value="'.$qty_rec.'"></td>
