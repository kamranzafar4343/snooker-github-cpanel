...
$query = "SELECT * FROM tbl_purchase_req_detail where purchase_req_id=$po and pur_item_id!='0'";
...
if(mysqli_num_rows($result)=='')
{
  ...
  $query1 = "SELECT * FROM tbl_purchase_req_detail where purchase_req_id=$po and pur_item_id='0'";
...
$qty_num=0;
     while($row = mysqli_fetch_array($result) ){
                        ...
                        while($data5 = mysqli_fetch_array($result5) ){
                          $transfer_perc=$data5['transfer_perc'];
...
for($z=0; $z<$qty_num; $z++)
{
  ...
  while($data1 = mysqli_fetch_array($result2) ){
      ...
      echo '                
                        ...
                        <td>
                          <input type="text"  name="cash_rate[]" id="cash_rate_'.$i.'" readonly="" class="form-control calculate cash_rate"  required=""  autocomplete="off" onchange="getTotal('.$i.')" value="'.$cash_rate.'">

                          
                        </td>
                        <td>
                          <input type="text" readonly="" name="inst_rate[]" readonly="" id="inst_rate_'.$i.'" class="form-control inst_rate"  autocomplete="off" required="" value="'.$inst_rate.'">
