...
{
    $where_item='group by tbl_items.item_id order by tbl_items.id ASC limit 9 ';
}
else{
...
echo '<div class="col-xl-4 col-lg-2 col-md-3 col-sm-4 col-6">
                                        <div class="productCard text-center" style="padding:10px; background-color: #e9ecef;" >
                                            ...
                                            <div class="productContent badge-secondary">
