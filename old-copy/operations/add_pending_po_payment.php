...
if($edit_id!='')
{
	 	...
	 	$sql=mysqli_query($conn, "UPDATE tbl_purchase SET   narration='$custom_narration',amount_payed='$total_amt', amount_remaining='$amount_remaining', payment_status='$payment_status',bank_id='$bank_id',check_no='$check_no',payment_method='$payment_method', payment_date='$created_date', created_by='$created_by' where purchase_id='$edit_id'");
...
{
	$narration="Amount Paid Against ".$PO." # ".$tranid." Net Amount was ".$net_amount." Amount Payed was ".$total_amt." Payment Date was ".$created_date." GRN Date was ".$invoice_date." (CUSTOM NARRATION =". $custom_narration.")";
...
{
	$narration="Amount Paid Against ".$PO." # ".$tranid." Net Amount was ".$net_amount." Amount Payed was ".$total_amt." Amount Remaining was ".$amount_remaining." Payment Date was ".$created_date." GRN Date was ".$invoice_date." (CUSTOM NARRATION =". $custom_narration.")";
	if($payment_method=='Bank Payment')
	{
		$v_type='BP';
		$acode=mysqli_real_escape_string($conn, $_POST['bank_id']);
...
$sql=mysqli_query($conn, "INSERT INTO tbl_trans(vendor_id, invoice_no, narration, total_amount, amount_payed, v_type, bill_status , payment_status, bank_id, check_no, payment_method, created_date, created_by, parent_id) VALUES ('$vendor_id', '$invoice_no', '$narration', '$net_amount', '$total_amt',  '$v_type', 'Completed', '$payment_status', '$bank_id', '$check_no','$payment_method', '$created_date', '$userid','$parent_id')");
...
$vendor_id=mysqli_real_escape_string($conn, $_POST['vendor']);
			...
			$sql = "INSERT INTO tbl_trans_detail (trans_id, invoice_no, acode, d_amount, c_amount, bill_status, narration,  created_date, created_by,parent_id) VALUES ('$tran_id', '$invoice_no', '$vendor_id','$amount_payed', '0.00','Pending', '$narration2', '$created_date', '$created_by', '$parent_id')";
            mysqli_query($conn, $sql);  

            $sql = "INSERT INTO tbl_trans_detail (trans_id, invoice_no,  acode, d_amount, c_amount, bill_status, narration,  created_date, created_by,parent_id) VALUES ('$tran_id', '$invoice_no', '$acode', '0.00', '$amount_payed','Pending','$narration1', '$created_date', '$created_by', '$parent_id')";
            mysqli_query($conn, $sql);          
