...
if($edit=='')
{
  ...
  $query = "SELECT * FROM tbl_purchase_req_detail where purchase_req_id='$po' and qty_rec!='' and pur_item_id!='0' and recieved='0' ";
}
else
{
...
error_reporting(0);
     ...
     while($row = mysqli_fetch_array($result) ){
                        ...
                        $sql="SELECT item_id,item_name, brand_id  FROM tbl_items where item_id='$product'";
      ...
      echo '                
                        ...
                        <td hidden><input type="number" name="trans_parent_id[]" id="trans_parent_id_'.$i.'" required readonly class="form-control" value="'.$trans_parent_id.'"><input type="text"  name="pur_item_id[]" id="pur_item_id_'.$i.'" readonly="" class="form-control" required value="'.$pur_item_id.'" onchange="chkprodser('.$i.')"></td>
                        ...
                        <td hidden><input type="text"  name="barcode[]" id="barcode_'.$i.'" readonly="" class="form-control" required value="'.$barcode.'" onchange="chkbar('.$i.')"></td>
                        <td><input type="text"  name="qty_tran[]" id="qty_tran_'.$i.'" readonly=""  class="form-control calculate" onchange="getTotal('.$i.')" value="'.$qty.'"></td>
                        ...
                        <td hidden>
                         ...
                         <td hidden><button type="button" class="btn btn-default" onclick="removeRow('.$i.')"><i class="fa fa-close"></i></button></td>
