...
error_reporting(0);
     ...
     while($row = mysqli_fetch_array($result) ){
                        ...
                        $sql1="SELECT * FROM tbl_items where item_id='$product'";
...
// {
  $i++;
      ...
      echo '                
                        ...
                        <td><input type="text"  name="item_serial[]" required id="item_serial_'.$i.'" class="form-control item_serial" maxlength="15" minlength="15" autocomplete="off" value="'.$item_serial.'" onchange="chkprodser('.$i.')"></td>
                        <td hidden><input type="text"  name="barcode[]"  id="barcode_'.$i.'" class="form-control barcode"  value="" onchange="chkbar('.$i.')"></td>
                        <td hidden><input type="text"  readonly="" name="qty_rec[]" id="qty_rec_'.$i.'" tabindex="-1" class="form-control calculate" required onchange="getTotal('.$i.')" value="1"></td>
                        <td><input type="text" readonly="" name="qty[]" id="qty_'.$i.'" tabindex="-1" class="form-control calculate" required onkeyup="getTotal('.$i.')" value="1"></td>
                        <td>
                        ...
                        <td>
                          <input type="text" readonly="" name="amount[]" id="amount_'.$i.'" tabindex="-1"  class="form-control"  autocomplete="off" readonly="" value="'.$rate_single.'">
