...
if($iemi=='1')
    {
        $sale_type='Local Lease Sale (IEMI)';
        $invoice_no="Installment"."_".$leasesaleid;
    }
    else
    {

        $sale_type='Local Lease Sale';
        $invoice_no="Installment"."_".$leasesaleid;
