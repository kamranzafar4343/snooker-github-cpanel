...
include "../includes/session.php";
	...
	else
	{
		...
		$sql=mysqli_query($conn, "DELETE FROM tbl_ tbl_trans_detail WHERE invoice_no = $invoice_no");
		$sql=mysqli_query($conn, "DELETE FROM tbl_ tbl_trans WHERE invoice_no = $invoice_no");
		$edit_id=$edit;
	}
