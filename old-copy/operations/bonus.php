...
$staff_mem_salary=mysqli_real_escape_string($conn, $_POST['bonus']);
...
$sql=mysqli_query($conn, "INSERT INTO tbl_bonus(emp_id, bonus, remarks, created_date, created_by) VALUES ('$staff_mem_id', '$staff_mem_salary', '$remarks', '$created_date', '$userid')");

$salaryid = mysqli_insert_id($conn); 
$invoice_no="Bonus"."_".$salaryid;

$narration="Bonus of ".$staff_mem_salary." given on transaction Date ".$created_date." and remarks ".$remarks."";
$v_type='CP';
...
$cash_code='100100000';
            ...
            mysqli_query($conn, $sql);
            	...
            	$sql = "INSERT INTO tbl_trans_detail (trans_id, invoice_no, acode, d_amount, c_amount, bill_status,narration,  created_by, parent_id) VALUES ('$tranid', '$invoice_no', '$cash_code', '0.00', '$staff_mem_salary','Completed','$narration', '$userid', '$parent_id')";
            mysqli_query($conn, $sql);
	if($sql){
