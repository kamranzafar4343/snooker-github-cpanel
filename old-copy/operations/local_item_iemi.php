...
for($z=0; $z<$qty_num; $z++)
{
  $i++;
      echo '                
                        ...
                        <td><input type="text"  name="item_serial[]" required id="item_serial_'.$i.'" class="form-control calculate item_serial"  value="'.$item_serial.'" onchange="chkprodser('.$i.')" maxlength="15" minlength="15"></td>
