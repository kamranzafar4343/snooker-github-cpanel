                         ...
                         for($z=0; $z<$qty_num; $z++)
{
  $i++;
      ...
      echo '                
                        ...
                        <td><input type="text"  name="item_serial[]" required id="item_serial_'.$i.'" class="form-control item_serial calculate" maxlength="15" minlength="15" autocomplete="off" value="" onchange="chkprodser('.$i.')"></td>
