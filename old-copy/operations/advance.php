...
$staff_mem_id=mysqli_real_escape_string($conn, $_POST['emp_id']);
$staff_mem_salary=mysqli_real_escape_string($conn, $_POST['advance']);
$remarks=mysqli_real_escape_string($conn, $_POST['remarks']);
$created_date=mysqli_real_escape_string($conn, $_POST['created_date']);
$date_trans=date(''.$created_date.' H:i:s');
...
$narration="Salary remarks ".$remarks." transaction Date ".$created_date."";
$v_type='CP';
...
$cash_code='100100000';
            ...
            $sql = "INSERT INTO tbl_trans_detail (trans_id, invoice_no, acode, d_amount, c_amount, bill_status,narration, created_date, created_by, parent_id) VALUES ('$tranid', '$invoice_no', '$salary_acode','$staff_mem_salary', '0.00','Completed', '$narration',  '$date_trans', '$userid', '$parent_id')";
            mysqli_query($conn, $sql);

              $sql = "INSERT INTO tbl_trans_detail (trans_id, invoice_no, acode, d_amount, c_amount, bill_status,narration,  created_date, created_by, parent_id) VALUES ('$tranid', '$invoice_no', '$cash_code', '0.00', '$staff_mem_salary','Completed','$narration', '$date_trans', '$userid', '$parent_id')";
            mysqli_query($conn, $sql);
  if($sql){
