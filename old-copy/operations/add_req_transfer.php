...
if($edit_id!='')
{
		  ...
		  for ($a = 0; $a < count($_POST["qty"]); $a++)
        {
        		$product=$_POST["product"][$a];
    				...
    				$sql=mysqli_query($conn, "DELETE FROM tbl_purchase_req_detail WHERE purchase_req_id = '$edit_id' and product='$product' and item_serial=''");
            ...
            $sql=mysqli_query($conn, "UPDATE tbl_purchase_detail SET transfer='1' where item_serial='" . $_POST["item_serial"][$a] . "'  and product='" . $_POST["product"][$a] . "'");
        }
