...
item_serial NOT IN (SELECT 
 ...
 AND item_serial NOT IN (SELECT 
  ...
  AND tbl_purchase_req_detail.recieved!='0' and tbl_purchase_req_detail.iemi='1' and tbl_purchase_req_detail.product='$product' and tbl_purchase_req_detail.transfer='0' $created Limit $qty_num"; 
