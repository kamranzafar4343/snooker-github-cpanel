...
$invoice_no="Salary_".$edit_id;
 ...
 $sql="SELECT branch_id,user_privilege,created_by  FROM users where user_id='$userid'";
            ...
            $sum_balance=round($total_balance+$amount_old);
...
$salary_acode='500100400';
           $sql = "INSERT INTO tbl_trans_detail (trans_id, invoice_no, acode, d_amount, c_amount, bill_status,narration, created_by, parent_id) VALUES ('$tranid', '$invoice_no', '$salary_acode','$amount', '0.00','Completed', '$narration',  '$userid', '$parent_id')";
            mysqli_query($conn, $sql);
                ...
                $sql = "INSERT INTO tbl_trans_detail (trans_id, invoice_no, acode, d_amount, c_amount, bill_status,narration,  created_by, parent_id) VALUES ('$tranid', '$invoice_no', '$branch_id', '0.00', '$amount','Completed','$narration', '$userid', '$parent_id')";
            mysqli_query($conn, $sql);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if($sql){
		header('Location: ../edit_ledger.php?updated=done&invoice_no='.$invoice_no.'&acode='.$salary_acode.'&created_at='.$date.'');
	}
