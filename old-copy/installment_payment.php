            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Installment Payment</h2>
                        <ul class="breadcrumb">
    ...
    <?php
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                   <form action="operations/installment_payment.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="body">
                            <div class="row clearfix"> 
                              <div class="col-md-4 col-sm-12">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    <div class="form-group">      
                                    <?php if($userid=='1'){?> 
                                     <input type="date" name="invoice_date" id="date_now" required=""  class="form-control" placeholder="Manual Invoice Date"  value="<?php if($invoice_date){echo $invoice_date;}else{?><?php echo $date;} ?>" >
                                    <?php }
                                    else if($P=='1' && $userid!='1'){?>      
                                        <input type="date" name="invoice_date"  id="date_now" required=""  class="form-control" placeholder="Manual Invoice Date"  value="<?php if($invoice_date){echo $invoice_date;}else{?><?php echo $date;} ?>" >
                                    <?php }else {?>
                                        <input type="date" name="invoice_date"  id="date_now" required=""  class="form-control" placeholder="Manual Invoice Date"  value="<?php if($invoice_date){echo $invoice_date;}else{?><?php echo $date;} ?>" min="<?php echo date('Y-m-d'); ?>">
                                    <?php }?>  
                                     <input type="hidden" name="to_date"  id="to_date" required=""  class="form-control" placeholder="Manual Invoice Date"  >
                                </div>
                              </div>
                                </div> 
                                <div class="col-md-4 col-sm-12">
                                 ...
                                 <div class="col-md-4 col-sm-12">
                                    ...
                                    <div class="form-group">        
                                        <select class=" form-control Installment_id"  id="Installment_id" name='customer' onchange="getproduct()">
                               ...
                               <div class="col-md-4 col-sm-12">
                                ...
                                <div class='col-md-12 col-sm-12' >
                                  ...
                                  <div class="col-md-8 col-sm-12">
                                    ...
                                    <div class="form-group">        
                                        <textarea  name="narration" id="narration" class="form-control" placeholder="Narration"  value=""></textarea>
                                </div>
                              </div>
                                </div>
                                 <div class="col-md-4 col-sm-12">
                                  <div class='col-md-8 col-sm-4' style="padding-top: 19%;padding-bottom: 2px;">
                                    ...
                                    <div class="form-group">        
                                        <a href="#largeModal1" data-toggle="modal" data-target="#largeModal1"><button type="button" class="btn btn-primary ">Add Notes</button></a>
                                </div>
                              </div>
                                </div>
                                        ...
                                        <table class="table table-hover" >
                                            <thead class="thead-success">
                                                <tr>
                                                    ...
                                                    <th >Paid Date</th>
                                                    <th class="text-right">For Month</th>
                ...
                <br><hr>
             <div class="col-md-12 col-xs-12"  id="Installment_notes">
                                         <div class="row clearfix" >
                <div class="col-lg-12 col-md-12">
                    <div class="card invoice1">                        
                        <div class="body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control calculate"  id="per_month_payment" name="per_month_payment"  autocomplete="off" value="<?php echo $per_month_payment;?>" >
                 ...
                 <div class="col-sm-12">
                  ...
                  <div class="modal fade" id="largeModal1" tabindex="-1" role="dialog">
                          <div class="modal-dialog modal-lg" role="document">
                            <form  action="operations/Installment_notes.php" method="post" enctype="multipart/form-data">
                              <div class="modal-content">
                                  <div class="modal-header">
                                      <h4 class="title" id="largeModalLabel">Add Notes</h4>
                                  </div>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <label>Notes *</label>
                                    <div class="form-group">
                                        <textarea  name="plan_notes" id="plan_notes" class="form-control" placeholder="Remarks"  value="" required=""></textarea>
                                        <input type="hidden" class="form-control" name="plan_notes_id" id="plan_notes_id">
                                    </div>
                                </div>
                                  ...
                                  <div class="modal-footer">
                                      <button type="submit" class="btn btn-primary" name="add_subhead">SAVE CHANGES</button>
...
get_details();
 function get_details()
 {
  ...
  if(sale_type=='InstallmentPayment')
  {
                $.ajax({
                  method: "POST",
                  url: "operations/get_installmentcustomer.php",
                  dataType: 'json',
                    ...
                    $(".Installmentproduct").show();
                       ...
                       $("#Installment_id").empty();
                        ...
                        for( var i = 0; i<len; i++){
                            ...
                            var mobile_no1 = response[i]['mobile_no1'];
                            var client_cnic = response[i]['client_cnic'];
                            var seprate_customer_id = response[i]['seprate_customer_id'];
                 

                            $("#Installment_id").append("<option value='"+customer_id+"'>"+username+" ("+seprate_customer_id+")"+" ("+mobile_no1+")("+client_cnic+")"+"</option>");
                    ...
                    $("#product_name").empty();
                     ...
                     $("#Installment_detail").show();
                          for( var i = 0; i<len; i++){
                            ...
                            $("#product_name").append("<option value='"+id+','+plan_id+"'>"+brand_name + ' ' +item_name+ ' (' + barcode + ')' + ' (' + item_serial + ')'+"</option>");
...
<script type="text/javascript">
        ...
        var Installment_id=$("#Installment_id").val();
        const plan_id = product_name.split(",", 2);
      ...
      $.ajax({
                  method: "POST",
                  url: "operations/get_installmentdetail.php",
                  data: {product_name:product_name, Installment_id:Installment_id, plan:plan},
                  dataType: 'json',                
                })
                .done(function(response){
                  ...
                  var len = response.length;
                    ...
                    $("#mo").empty();
                          for( var i = 0; i<len; i++){
                            ...
                            var to_date = response[i]['to_date'];
     ...
     function get_installmentdetail(){
        ...
        var planid=$("#plan_id").val();
          ...
          $.ajax({
            type: "POST",
            url:"operations/get_installment_detail_per_month.php",
            data: {planid:planid},
     ...
     function get_installmentnotes(){
        ...
        var planid=$("#plan_id").val();
          ...
          $.ajax({
            type: "POST",
            url:"operations/Installment_notes_detail.php",
            data: {planid:planid},
         
           success:function(data)
           {

            $('#Installmentnotes').html(data);
           }
          })
...
var dateObj = new Date(date_now);
var month = dateObj.getUTCMonth() + 1; 
var day = dateObj.getUTCDate();
var year = dateObj.getUTCFullYear();

var dateObj1 = new Date(to_date);
var month1 = dateObj1.getUTCMonth() + 1; 
var day1 = dateObj1.getUTCDate();
var year1 = dateObj1.getUTCFullYear();

if (new Date(year, month) < new Date(year1, month1)){
  alert('Please Select Process date for '+year1+'-'+month1+'-01');
  return false;
}
if(sale_type=='InstallmentPayment')
 {
...
var one_month_payment=$('#one_month_payment').val();
var one_month_payment1=Math.round(one_month_payment);
...
if(Number(one_month_payment1)>Number(per_month_payment1))
{
  alert('Opps! Please add amount equal or greater than Per Month Amount..!');
    $('#amount_recieved').val('');
    $('#amount_recieved').focus();
...
return false;
  ...
  if(per_month_payment=='' || per_month_payment=='0' || isNaN(per_month_payment))
  {
    alert('Opps! Please add amount equal or greater than Per Month Amount..!');
    
    $('.Installment_id').select2('focus');
$('.Installment_id').select2('open');
return false;
