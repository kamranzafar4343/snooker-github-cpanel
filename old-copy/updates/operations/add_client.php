...
if ($uploadOk == 0) {
   header('Location: ../client_list.php?wronguploaded=true');                
	...
	if(move_uploaded_file($_FILES["user_profile"]["tmp_name"], $target_file)) {
		...
		$sql=mysqli_query($conn, "INSERT INTO tbl_customer(customer_id,seprate_customer_id, username,mobile_no1, mobile_no2, address_permanent, address_current, address_office, client_occupation, client_salary, client_residential, client_fathername, gender, client_cnic, zone, sub_zone, created_by, parent_id, created_date,user_profile) VALUES('$customer_id', '$seprate_customer_id', '$username','$mobile_no1','$mobile_no2', '$address_permanent','$address_current', '$address_office','$client_occupation','$client_salary',  '$client_residential', '$client_fathername','$gender','$client_cnic', '$zone', '$sub_zone', '$userid','$parent_id','$date','$targetimage')");
	...
	$sql=mysqli_query($conn, "INSERT INTO tbl_customer(customer_id, seprate_customer_id,  username,mobile_no1, mobile_no2, address_permanent, address_current, address_office, client_occupation, client_salary, client_residential, client_fathername, gender, client_cnic, zone, sub_zone, created_by, parent_id,  created_date) VALUES('$customer_id', '$seprate_customer_id', '$username','$mobile_no1','$mobile_no2', '$address_permanent','$address_current', '$address_office','$client_occupation','$client_salary', '$client_residential', '$client_fathername','$gender','$client_cnic' ,  '$zone', '$sub_zone','$userid','$parent_id','$date')");
...
if(isset($_POST['addclientspos'])){
	...
	if($sql)
	{
		header('Location: ../pos.php?add=successfull');
	}
	else
	{
		header('Location: ../pos.php?add=unsuccessful');
	}
