...
$salary_acode='500100400';
            ...
            mysqli_query($conn, $sql);
            	...
            	$sql = "INSERT INTO tbl_trans_detail (trans_id, invoice_no, acode, d_amount, c_amount, bill_status,narration,  created_by, parent_id) VALUES ('$tranid', '$invoice_no', '$branch_id', '0.00', '$staff_mem_salary','Completed','$narration', '$userid', '$parent_id')";
            mysqli_query($conn, $sql);
