            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Stock Sale Profit Wise Report</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>                            
                            <li class="breadcrumb-item"> Stock Sale Profit Wise Report</li>
                        ...
                        <div class="row">
                            <div class="invoice-top clearfix col-md-12">
                                ...
                                <div class="info text-center col-md-12" style="margin-top: 1%;" >
                                    ...
                                    <h3  class="text-center">Stock Sale Profit Wise Report</h3>
                         ...
                         <form  action="stock_sale_profit.php" method="post" enctype="multipart/form-data" id='form1'>
                        <div class="body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <tbody id="stock">
                                      ...
                                      $sql=mysqli_query($conn,"SELECT * FROM tbl_installment INNER JOIN tbl_items ON tbl_installment.item_id = tbl_items.item_id WHERE  Date(tbl_installment.created_date) BETWEEN '$f_date' and '$t_date' $where_branch");
                                       ...
                                       $profit=round($total_price-$purchase_req_rate);
                                      ?>  
                                                        <tr>
                                                            ...
                                                            <td><h7 class="m-b-0 m-t-6"><?php echo number_format($profit); $inst_profit+=$profit;?></h7></td>
                                      ...
                                      $sql=mysqli_query($conn,"SELECT * FROM tbl_sale_detail INNER JOIN tbl_items ON tbl_sale_detail.product = tbl_items.item_id WHERE  Date(tbl_sale_detail.created_date) BETWEEN '$f_date' and '$t_date' $where_branch1");
                                        ...
                                        else
                                        {
                                         ...
                                         $profit1=round($sale_rate-$purchase_req_rate);
                                      ...
                                      ?>  
                                                       <tr>
                                                            ...
                                                            <td><h7 class="m-b-0 m-t-6"><?php echo number_format($profit1); $cash_profit+=$profit1;?></h7></td>
                                                    ...
                                                    <?php }?>
                                                        <tr>
                                                            ...
                                                            <td><h5 class="m-b-0 m-t-6"><?php echo number_format($cash_profit+$inst_profit);?></h5></td>
                                                            <td></td>
                                                            <td></td>
...
$(document).ready(function() {
    ...
    $('#example').DataTable({
      ...
      buttons: [
          ...
          extend: 'pdf',
          text: 'PDF',
          title: '<?php echo $c_name;?> (Stock Sale Profit Wise Report)',
