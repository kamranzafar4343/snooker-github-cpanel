            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Create New Stock Transfer</h2>
                        <ul class="breadcrumb">
...
<?php
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                   <form action="operations/add_req_transfer_gen.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="body">
                            <div class="row clearfix"> 
                                      ...
                                      ?>
                                        <select class="form-control po"  name="po" onchange="get_detail();" >
                                          <option selected="" value="">-- Chose One --</option>
                                           <?php
                                            $sql="SELECT * FROM tbl_purchase_req where stock_status='Pending' and iemi='0' and transfer_type='0'"; 
                                            foreach ($conn->query($sql) as $row){
                  ...
                  <thead style="background-color: orange;">
                    <tr>
                      ...
                      <th style="width:10%">Item Serial/ IEMI</th>
