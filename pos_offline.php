...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
	...
	<link href="assets/cdn.datatables.net/1.10.22/css/jquery.dataTables.min.css" rel="stylesheet" type="text/css" />
	<link href="assets/unpkg.com/multiple-select%401.5.2/dist/multiple-select.min.css" rel="stylesheet">
...
<body id="tc_body" class="header-fixed header-mobile-fixed subheader-enabled aside-enabled aside-fixed">
	    ...
	    <div class="container-fluid">
			<div class="row" >
				<div class="col-xl-4 order-xl-first order-last">
					<div class="card card-custom gutter-b bg-default border-0">
						...
						<div class="card-body">
							...
							<div class="product-items">
								<div class="row"  id="side_products">
							...
							<div class="card-body">
								...
								<div class="d-flex justify-content-between colorfull-select">
									<div class="selectmain">
										...
										<select class="arabic-select select-down " id="customer" name="customer" style="width: 500px;">
                                ...
                                else
                                {
                                  $sql="SELECT * FROM tbl_account_lv2 where Left(acode,6)='100200' and created_by='$userid'";
                                            ...
                                            if($row['anmae']=='Walk in Customer' && $edit_id=='')
                                            {
                                            echo "<option value=$row[acode] selected>$row[aname]</option>"; 
                                            }
                                            else if($row['acode']==$customer_name && $edit_id!='')
                                            {
                                            echo "<option value=$row[acode] selected>$row[aname]</option>"; 
                                            }
                                            else
                                            {
                                            echo "<option value=$row[acode]>$row[aname] ($branchname) ($iden1$iden2"._."$seprate_customer_id) ($mobile_no1) ($client_cnic)</option>"; 
                                            }
                                            }
								...
								<!-- <div class="d-flex flex-column selectmain">
									<label class="text-dark d-flex" >Salesman  
									
									</label>
									<select class="arabic-select select-down" name="sales_men" id="sales_men">
										 <?php
                                           $query=mysqli_query($conn, "SELECT user_privilege,created_by FROM users where user_id='$userid'");
                                $data = mysqli_fetch_assoc($query);
                                $user_privilege=$data['user_privilege'];
                                ...
                                else
                                {
                                  $sql="SELECT * FROM tbl_salesmen where created_by='$created_by' and designation LIKE '%Salesman%'";
                                            ...
                                            foreach ($conn->query($sql) as $row_sale){
                                              
                                            if($row_sale['s_id']==$sales_men_edit)
                                            {
                                            echo "<option value=$row_sale[s_id] selected>$row_sale[username]</option>"; 
                                            }
                                            else
                                            {
                                            echo "<option value=$row_sale[s_id]>$row_sale[username] </option>"; 
                                            }
                                            }
							...
							<div class="card-body" >
								...
								<div class="form-group row mb-0">
									<div class="col-md-12">
										...
										<input class="form-control" list="datalistOptions" id="product_search" placeholder="Type to search..." style="max-height: 50px;" autocomplete="off">
							...
							<div class="resulttable-pos">
								<table class="table right-table">
									...
									<tbody>
										...
										<td class="border-0 justify-content-end d-flex text-dark font-size-base">
											<select class="form-control badge-secondary text-white" name="sale_type" id="sale_type" style="width: 180px;">
									  ...
									  <tr class="d-flex align-items-end justify-content-between" style="border-top:1px solid #000 !important">
										<th class="border-0 ">
									  ...
									  <tr class="d-flex align-items-center justify-content-between item-price" style="border-top:1px solid #000 !important">
										...
										<td class="border-0 justify-content-end d-flex text-primary font-size-base"><input type="text" name="total_amount_return" id="total_amount_return" readonly="" tabindex="-1" required class="form-control text-right" value="<?php echo round($amount_recieved-$net_amount);?>" style="background-color: transparent; border: 0px solid; height: 30px; width: 100px; color: black; font-size: 20px;"></td>
							 ...
							 <div class="d-flex justify-content-end align-items-center flex-column buttons-cash">
								<div> 
									<button type="submit" class="btn btn-primary white mb-2" id="submit_form">
			...
			<form action="operations/add_client.php" method="post">
				<div class="form-group row">
					...
					<div class="col-md-6">
						...
						<fieldset class="form-group mb-3">
							<input type="text" class="form-control"  name="mobile_no1" data-inputmask="'mask': '0399-99999999'"  type = "number" maxlength = "12" required="">
						</fieldset>
					</div>
				</div>
				<div class="form-group row">
					<div class="col-md-6">
						...
						<fieldset class="form-group mb-3">
							<input type="text"  name="client_cnic" class="form-control" required=""  data-inputmask="'mask': '99999-9999999-9'"  placeholder="XXXXX-XXXXXXX-X"  required="">
						</fieldset>
					</div>
					<div class="col-md-6">
  ...
  <div class="modal fade text-left" id="folderpopkeys" tabindex="-1" role="dialog" aria-labelledby="myModalLabel16" style="display: none;" aria-hidden="true">
	<div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg " role="document">
		<div class="modal-content">
		  <div class="modal-header">
				 ...
				 <div class="col-lg-4">
				  ...
				  <div class="col-lg-4">
					  <div class="pos-order">
						...
						<div class="orderdetail-pos">
							<p>
								<strong>For Suspend/Delete Order</strong>
								<p>Press (DELETE)</p>
							</p>
						</div>
					  </div>
   ...
   <div class="modal fade text-left" id="folderpop" tabindex="-1" role="dialog" aria-labelledby="myModalLabel14" style="display: none;" aria-hidden="true">
				  ...
				  <div class="col-lg-4">
					  ...
					  <div class="pos-order">
						...
						<div class="d-flex justify-content-end">
							<a href="#"  class="ml-3 edit_order_pending" title="Edit" data-sale="<?php echo $ref_id_pending;?>"><i class="fas fa-edit"></i></a>
	...
	<!-- <script src="assets/cdn.datatables.net/1.10.22/js/jquery.dataTables.min.js"></script> -->
	<script src="assets/unpkg.com/multiple-select%401.5.2/dist/multiple-select.min.js"></script>
...
$(document).ready(function(){
    ...
    $.ajax({
                ...
                data: {product_search_side:product_search_side},             
                })
		...
		if(item_id!='')
			{
                ...
                data: {item_id:item_id, barcode:barcode, item_serial:item_serial, pur_item_id:pur_item_id, sale_rate:sale_rate, ref_id:ref_id, stock:stock, customer:customer, sales_men:sales_men},             
                })
                .done(function(response){
...
// $("#product_search1").on("input", function () {
    ...
    if(row) {
      ...
      //$("#amount_"+row).val(total);
     	...
     	$.ajax({
                ...
                data: {tr_id:tr_id, ref_id:ref_id, qty:qty, stock:stock},             
                })
                .done(function(response){
...
function subAmountReturn() {
  ...
  function removeRow(tr_id)
  {
  	...
  	$.ajax({
                ...
                data: {tr_id:tr_id, ref_id:ref_id},             
                })
                .done(function(response){
