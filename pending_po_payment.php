                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                              ...
                              <div class="col-md-3 col-sm-12">
                                      ...
                                      ?>
                                        <select class="form-control po"  name="po" onchange="get_detail();" >
                                          <option selected="" value="">-- Chose One --</option>
                                           <?php
                                            $sql="SELECT * FROM tbl_purchase where payment_status='Pending' and amount_remaining!='' and created_by='$userid' and iemi='0'"; 
                                            foreach ($conn->query($sql) as $row){
                                ...
                                <div class="col-md-3 col-sm-12">
                                    ...
                                    <div class="form-group">      
                                      ...
                                      if($edit_id)
                                      {?>
                                      <input type="text" id="vendor_name" name="vendor" required="" readonly="" class="form-control"  value="<?php echo $vendor_name; ?>">
                                      <?php }else{ 
                                      ?>
                  ...
                  <thead style="background-color: orange;">
                    <tr>
                      ...
                      <th style="width:20%" hidden>Product Serial</th>
...
var po=$('.po').val();
  ...
  $.ajax({
                url: "operations/get_details_genral_items.php",
                type: "POST",
                data: {
                    po : po
                },
