            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Purchase Report</h2>
                        <ul class="breadcrumb">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card invoice1">                        
                        ...
                        <div class="row">
                         ...
                         <form  action="single.php" method="post" enctype="multipart/form-data" id='form1'>
                        <div class="body">
...
if($vendors == "All"){
  ...
  $where_vendors="";
    ...
    $where_vendors="and tbl_purchase.vendor_id='$vendors'";
                               ...
                               else
                               {
                                $created_by=$created_by;
                                    ...
                                    if($branch=='')
                                      ...
                                      {
                                          $where_created=' and tbl_purchase.parent_id="'.$created_by.'"';

                                      }
     $bsql=mysqli_query($conn,"SELECT * FROM tbl_purchase where  DATE(tbl_purchase.created_date) between '$f_date' and '$t_date'  $where_vendors  group by tbl_purchase.vendor_id order by DATE(tbl_purchase.created_date) asc");
...
while($value = mysqli_fetch_assoc($bsql))   
                                {   
                                    ...
                                    $bsql2=mysqli_query($conn,"SELECT net_amount, purchase_id From tbl_purchase where  DATE(tbl_purchase.created_date) between '$f_date' and '$t_date'  and vendor_id='$vendor_id'");
                                    while($value1 = mysqli_fetch_assoc($bsql2))
                                    {
                                    $net_amount1+=round($value1['net_amount'], 0);
                                    $purchase_id=$value1['purchase_id'];
                                    
                                    $bsql3=mysqli_query($conn,"SELECT SUM(qty) as t_qty From tbl_purchase_detail where  purchase_id='$purchase_id'");
                                    $value3 = mysqli_fetch_assoc($bsql3);
                                    $t_qty+=$value3['t_qty'];
                                    }
 ...
 $count++;
  ?>
                          <tr>
                            ...
                            <td><?php echo $net_amount1;  $total_amount+=$net_amount1;?></td>
                          </tr>
                          <?php }?>
                                                    </tbody>
                                                </table>
      ...
      buttons: [
        {
          ...
          text: '<?php echo $c_name;?>',
           title: '<?php echo $c_name;?> (PO Report)',
