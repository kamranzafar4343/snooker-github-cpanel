...
<body class="theme-orange">
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30"><img src="https://wrraptheme.com/templates/lucid/hr/html/assets/images/logo-icon.svg"
                    width="48" height="48" alt="Alkareem"></div>
            <p>Please wait...</p>
        </div>
    </div>
  ...
  ?>
    ...
    <div id="main-content">
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i
                                    class="fa fa-arrow-left"></i></a> Complete JV Voucher</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item">JV Voucher</li>
                            <li class="breadcrumb-item active">Add Invalid JV Voucher</li>
                        </ul>
                    </div>
            ...
            <div class="alert alert-danger" id="no-balance1" style="display: none;">
                ...
                <strong>Sorry !</strong> Please Select Credit Account.
            </div>
      ...
      if (isset($_GET['jv_id'])) {
        ...
        $jv_id = mysqli_real_escape_string($conn, $_GET['jv_id']);
        $sql = mysqli_query($conn, "SELECT * FROM tbl_jv where jv_id=$jv_id");
      ...
      ?>
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <form action="operations/complete_jv.php" method="post" enctype="multipart/form-data">
                        <div class="card">
                            <?php
              ...
              ?>
                          ...
                          ?>
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        ...
                                        <div class='col-md-12 col-sm-4'>
                                            ...
                                            <div class="form-group">
                                                <?php if($userid=='1'){?>
                                                <input type="date" name="payment_date" required="" readonly=""
                                                    class="form-control" placeholder="Manual Invoice Date"
                                                    value="<?php if($payment_date){echo date('Y-m-d', strtotime($payment_date));}else{?><?php echo $date;} ?>">
                                                <?php }
                                                 else if($P=='1' && $userid!='1')
                                                  {?>
                                                <input type="date" name="payment_date" id="process_date" readonly=""
                                                    class="form-control" placeholder="Manual Invoice Date"
                                                    value="<?php if($payment_date){echo date('Y-m-d', strtotime($payment_date));}else{?><?php echo $date;} ?>">
                                                <?php }else {?>
                                                <input type="date" name="process_date" id="process_date" readonly=""
                                                    class="form-control" placeholder="Manual Invoice Date"
                                                    value="<?php if($payment_date){echo date('Y-m-d', strtotime($payment_date));}else{?><?php echo $date;} ?>"
                                                    min="<?php echo date('Y-m-d'); ?>">
                                                <?php }?>
                                                <input type="hidden" name="jv_id" value="<?php echo $jv_id;?>">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        ...
                                        <div class='col-md-12 col-sm-4'>
                                            ...
                                            <div class="form-group">
                                                <select class="form-control location" name="voucher_type"
                                                    id="voucher_type" onchange="get_balance();">
                        ...
                        ?>
                                                ...
                                                <input type="text" name="account" readonly="" id="remarks"
                                                    class="form-control" value="<?php echo $aname; ?>">
                                        ...
                                        <div class='col-md-12 col-sm-4'>
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="amount" readonly="" id="amount"
                                                    class="form-control" value="<?php echo $debit; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        ...
                                        <div class='col-md-12 col-sm-4'>
                                            ...
                                            <div class="form-group">
                                                <textarea name="remarks" id="remarks" class="form-control"
                                                    placeholder="Remarks" value=""><?php echo $remarks; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-bordered" id="product_info_table">
                                        <thead style="background-color: orange;">
                                            <tr>
                                                ...
                                                <th style="width:10%" hidden="">Debit</th>
                      ...
                      $acc_query = "SELECT acode,aname FROM tbl_account where acode not in ('200200000', '100200000', '$acc_id') UNION SELECT acode,aname FROM tbl_account_lv2 where acode not in ('$acc_id')";
                      if ($jv_id != '') {


                        $lsql = mysqli_query($conn, "SELECT * FROM tbl_jv where jv_id='$jv_id'");
                        $i = 0;
                      ...
                      ?>
                                            <tr id="row_<?php echo $i; ?>" hidden>
                                                <td>
                                                    <select class="form-control select_group acc"
                                                        data-row-id="row_<?php echo $i; ?>"
                                                        id="account_<?php echo $i; ?>" name="account[]"
                                                        style="width:100%;" required
                                                        onchange="get_balance(<?php echo $i; ?>);">

                                                        <?php


                                $acc_query1 = "SELECT acode,aname FROM tbl_account where acode not in ('200200000', '100200000') UNION SELECT acode,aname FROM tbl_account_lv2";
                                foreach ($conn->query($acc_query1) as $row) {
                                ...
                                ?>
                                                ...
                                                <td><input type="text" name="balance[]" id="balance_<?php echo $i; ?>"
                                                        class="form-control " value="<?php echo $balance; ?>" readonly
                                                        tabindex="-1"></td>

                                                <td><input type="text" name="narration[]"
                                                        id="narration_<?php echo $i; ?>" class="form-control "
                                                        value="<?php echo $narration_2; ?>"></td>
                                                
                                                <td>
                                                    <input type="text" name="debit[]" id="debit_<?php echo $i; ?>"
                                                        class="form-control calculate" required autocomplete="off"
                                                        onkeyup="getTotal(<?php echo $i; ?>)"
                                                        value="<?php echo $debit; ?>">
                                                </td>

                                                <td><input type="text" name="credit[]" id="credit_<?php echo $i; ?>"
                                                        readonly="" class="form-control calculate" autocomplete="off"
                                                        value="0"></td>
                                                <td><button type="button" class="btn btn-default"
                                                        onclick="removeRow('<?php echo $i; ?>')"><i
                      ...
                      $i = 2; ?>
                            ...
                            ?>
                                                ...
                                                <td><input type="text" name="narration[]"
                                                        id="narration_<?php echo $i; ?>" value="<?php echo $narration_2; ?>" class="form-control" required>
                                                </td>

                                                <td hidden><input type="text" name="debit[]"
                                                        id="debit_<?php echo $i; ?>" class="form-control calculate"
                                                        value="0" required autocomplete="off"
                                                        onkeyup="change_credit();"></td>

                                                <td><input type="text" name="credit[]" id="credit_<?php echo $i; ?>"
                                                        readonly="" class="form-control calculate" autocomplete="off"
                                                        value="<?php echo $debit; ?>"></td>
                                ...
                                <div class="col-sm-12 text-center">
                                    <div class="mt-4">
                                        ...
                                        <button type="button" class="btn btn-danger"
                                            onclick="GoBackWithRefresh();return false;">Back</button>
    ...
    $(function() {
        $(".submit").click(function() {
            ...
            var account = $("#account_" + count).val();
    ...
    $(document).ready(function() {
        ...
        $("#add_row").unbind('click').bind('click', function() {
            ...
            var html = '<tr id="row_' + row_id + '">' +
                '<td>' +
                '<select class="form-control select_group acc"  data-row-id="row_1" id="account_' +
                row_id + '" name="account[]" style="width:100%;"  required onchange="get_balance(' +
                row_id +
                ')"><option selected="selected" >Choose one</option><?php
                                                                                                                                                                                                                                                foreach ($conn->query($acc_query) as $row) {
            ...
            html += '</select>' +
                '</td>' +
                '<td><input type="text" name="balance[]" id="balance_' + row_id +
                '" required readonly tabindex="-1" class="form-control" ></td>' +
                '<td><input type="text" name="narration[]" id="narration_' + row_id +
                '" required class="form-control"></td>' +
                '<td><input type="number" name="debit[]" id="debit_' + row_id +
                '" readonly="" required  class="form-control" value="0"></td>' +
                '<td><input type="number" name="credit[]" id="credit_' + row_id +
                '" required  onkeyup="change_debit();" class="form-control"></td>' +
