            ...
            <div class="navbar-right">
                ...
                <div id="navbar-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="day_close.php" class='btn btn-outline-dark'>Day Close</a></li>
                        <li><a href="cash_book.php" class='btn btn-outline-success'>Cash Book</a></li>
                        <li><a href="pos.php?dinein_items=1" class="btn btn-outline-dark ml-3">View Table Status</a></li>
                 
                        <?php if ($user_privilege == 'superadmin') { ?>
    <li><a href="vendor_list.php" class='btn btn-outline-success'>Vendor List</a></li>
    <li><a href="employee_attandence.php" class='btn btn-outline-success mr-3'>Employee Attendance</a></li>
    <li><a href="general_ledger_report.php" class='btn btn-outline-dark mr-1'>General Ledger</a></li>
    <li><a href="new_stock_report.php" class='btn btn-outline-success mr-3'>Stock Check</a></li>
<?php } ?>

<li><a href="single_sale.php" class='btn btn-outline-dark mr-3'>Sale Report</a></li>
<li><a href="add_payment.php" class='btn btn-outline-dark mr-1'>Add Voucher/JV</a></li>
                        <li><a href="pos_sale_list.php" class='btn btn-outline-success mr-1'>Sale List</a></li>
                        <li><a href="pos.php" class='btn btn-outline-dark mr-1'>POS</a></li>
