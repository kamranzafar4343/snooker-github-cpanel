            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Stock In (IEMI)</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item">Stock In </li> 
                            <li class="breadcrumb-item active">Add Stock In (IEMI)</li>
                        </ul>
                    </div>            
                                        ...
                                        <select class="form-control po"  name="po" onchange="get_detail();" >
                                          <option selected="" value="">-- Chose One --</option>
                                           <?php
                                            ...
                                            $sql="SELECT * FROM tbl_purchase_req where item_total!=item_recieved and iemi='1' and transfer_type='2' and created_by='$userid'";
