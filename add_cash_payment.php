                ...
                <div class="row clearfix">
                  ...
                  <div class="col-md-4 col-sm-12">
                    ...
                    <div class="col-md-12 col-sm-4">
                      ...
                      $date_tommorow = date('Y-m-d', strtotime('+1 day'));
                      $default_date = $payment_date ?? $date;
                      $min_date = '';

                      if ($userid == '1') {
                        $min_date = ''; // no restriction
                        $max_date = '';
                      } else {
                        $min_date = $date_yesterday;
                        $max_date = $date_tommorow;
                      }
                      ?>
                      <div class="form-group">
                        <input
                          ...
                          name="payment_date"
                          class="form-control"
                          placeholder="Manual Invoice Date"
                          value="<?php echo $default_date; ?>"
                          <?php 
                          echo 'min="' . $min_date . '" max="' . $max_date . '"';
                          ?>
                          required>
                        <input type="hidden" name="edit_id" value="<?php echo $edit_id; ?>">
