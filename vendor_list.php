...
<link rel="stylesheet" href="https://cdn.datatables.net/1.11.1/css/jquery.dataTables.min.css">
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Vendors</h2>
                        <ul class="breadcrumb">
  ...
  <strong>Great!</strong> Vendor Deleted Succesfully.
</div>
              <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
                      ...
                      <div class="body">
                         <?php if($c_write=='1'){?>
                          ...
                          <button  class="btn btn-success m-b-15" type="button">
                                <i class="icon wb-plus" aria-hidden="true"></i> Add Vendors
                            </button>
                          </a>
    ...
    $(document).ready(function() {
        $('#customersTable').dataTable({
            ...
            buttons: [
            {
                ...
                title: '<?php echo $c_name;?> (Vendor List)',
