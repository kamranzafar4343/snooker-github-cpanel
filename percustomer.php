            ...
            <div class="row clearfix" >
                <div class="col-lg-12 col-md-12">
                    <div class="card invoice1">                        
                        ...
                        // print_r($v_id);
                        $namesql=mysqli_query($conn, "SELECT username FROM tbl_customer where customer_id=$purchase_id");
               ...
               // echo "string";
                        ...
                        $vendornamee = $dataa['username'];   ?>  
                            ...
                            <span > <b>Customer  : </b> <?php echo $customer_name;?></span>
                     </div> 
