            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Local Purchase (IEMI)</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item">Allow Local Purchase</li>
                            <li class="breadcrumb-item active">Allow Local Purchase (IEMI)</li>
                        </ul>
                    </div>            
...
<?php
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                   <form action="operations/allow_local_iemi.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="body">
                            <div class="row clearfix"> 
                                ...
                                <div class='col-md-8 col-sm-4' style="padding-top: 9px;padding-bottom: 4px;">
                                      ...
                                      <div class='col-md-12 col-sm-4'>
                                        ...
                                        <input type="hidden" name="purchase_req_id" id="purchase_req_id">
                                ...
                                <div class="col-md-4 col-sm-12">
                                     ...
                                     <div class='col-md-8 col-sm-4' style="padding-top: 9px;padding-bottom: 2px;">
                                       ...
                                       <label>Allowing to Location *</label>
                                      </div>
                                      <div class='col-md-12 col-sm-4'>
                                ...
                                <div class="col-md-8 col-sm-12" >
                                    ...
                                    <div class="form-group">   
                                        <textarea name="remarks" required=""  class="form-control"  row="1" id="remarks"></textarea>     
                  ...
                  <thead style="background-color: orange;">
                    <tr>
                      ...
                      <th style="width:10%">Inst Rate</th>
...
$.ajax({
                           ...
                           //           $("#cat").empty();
                                        for( var i = 0; i<len; i++){
                                            ...
                                            {
                                              alert('From Location must be Different than Receiving Location....');
                                              $('.po').val('');
                                              return false;
                                            }                                                                     
                                            $("#purchase_req_id").val(purchase_req_id);  
...
var po=$('.po').val();
  ...
  $.ajax({
                url: "operations/allow_iemi_detail.php",
                type: "POST",
                data: { 
                    po : po
                },
