     ...
     <div id="wrapper">
         ...
         <?php
            ...
            if ($user_privilege == 'superadmin' || $created_by == '1') {
                ...
                $sql_pur = mysqli_query($conn, "SELECT SUM(amount_payed) as today_purchase FROM tbl_purchase where  date(created_date) = DATE('$date')");


                $monthsql_pur = mysqli_query($conn, "SELECT SUM(amount_payed) as monthly_purchase FROM tbl_purchase where MONTH(created_date) = MONTH(CURRENT_DATE())
                ...
                $payable1 = mysqli_query($conn, "SELECT SUM(d_amount) as total_pay FROM `tbl_trans_detail` where LEFT(acode,6)='200200' and MONTH(created_date) = MONTH(CURRENT_DATE())
                AND YEAR(created_date) = YEAR(CURRENT_DATE())");

                $other_inc1 = mysqli_query($conn, "SELECT SUM(d_amount-c_amount) as other_inc1 FROM `tbl_trans_detail` where LEFT(acode,6)='300400' and MONTH(created_date) = MONTH(CURRENT_DATE())
                                        AND YEAR(created_date) = YEAR(CURRENT_DATE())");
            } else {
                ...
                $sql_pur = mysqli_query($conn, "SELECT SUM(amount_payed) as today_purchase FROM tbl_purchase where  date(created_date) = DATE('$date') and parent_id='$created_by'");
            ...
            $tot_rec = $tot_rec_before + $total_rec_open;
            ...
            //total paid to vendor - monthly
            $payable_tot1 = mysqli_fetch_assoc($payable1);
            $tot_pay_before_opening1 = $payable_tot1['total_pay'] ?? 0;

            $tot_pay1 = round($tot_pay_before_opening1);

            //other income
            $other_inc_row1 = mysqli_fetch_assoc($other_inc1);
            $other_income_result1 = $other_inc_row1['other_inc1'] ?? 0;

            $other_income = round($other_income_result1);
                 ...
                 <div class="row clearfix">
                         ...
                         <div class="card text-center bg-warning">
                             <div class="body">
                                 <div class="p-15 text-dark">
                                     ...
                                     <h3><?php echo round($tot_pay1 - $monthly_purchase); ?></h3>
                                     <span>Monthly Paid to Vendor</span>
                                 </div>
                             </div>
                         </div>
                     </div>
                     <div class="col-lg-2 col-md-6 col-sm-6">
                         <div class="card text-center bg-info">
                             <div class="body">
                                 <div class="p-15 text-light">
                                     <h3><?php echo round($other_income); ?></h3>
                                     <span>Monthly Other Income</span>
                                 </div>
                             </div>
                         </div>
                     </div>
                             ...
                             <div class="body">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-lg-6 col-md-12">
                                         ...
                                         <div class="content">
                                             ...
                                             <h5 class="number" style="color: green"><?php
                                                                                        ...
                                                                                        //fetch max date from cash book
                                                                                        $sql_max_time = mysqli_query($conn, "SELECT max(created_at) as last_date  FROM cash_book where created_by = '$userid'");
                                                                                        $data = mysqli_fetch_assoc($sql_max_time);
                                                                                        $max_created_time = $data['last_date']  ?? '0000-00-00 00:00:00';
                                                                                        // echo $max_created_time;
                                                                                        $sql3 = mysqli_query($conn, "SELECT SUM(d_amount-c_amount) as cash_in_hand FROM `tbl_trans_detail` WHERE LEFT(acode, 9) in ('100100000') and payment_type = 'cash' and created_by = '$userid' and created_date > '$max_created_time' ");
                                                                                        $data3 = mysqli_fetch_assoc($sql3);
                                                                                        $sale_list_cash = $data3['cash_in_hand'];
                                                                                        ...
                                                                                        $cash_only =  $sale_list_cash;

                                                                                        if ($cash_only) {
                                                                                            echo number_format($cash_only, 0, ".", ",");
                                                                                        } else {
                                                                                            echo  "RS - 0";
                                                                                        }
                                                                                        ?></h5>
                                     ...
                                     <div class="col-lg-6 col-md-12">
                                         ...
                                         <div class="content">
                                             ...
                                             <h5 class="number" style="color: orange"><?php
                                                                                        $sql = mysqli_query($conn, "SELECT branch_id, created_by  FROM users where user_id='$userid'");
                                                                                        $data = mysqli_fetch_assoc($sql);
                                                                                        $branch_id = $data['branch_id'];
                                                                                        $created = $data['created_by'];
                                                                                        ...
                                                                                        // echo $max_created_time;
                                                                                        $sql3 = mysqli_query($conn, "SELECT SUM(d_amount-c_amount) as cash_in_hand2 FROM `tbl_trans_detail` WHERE LEFT(acode, 9) in ('100100000') and created_by = '$userid' and payment_type = 'bank' and created_date > '$max_created_time' ");

                                                                                        $data3 = mysqli_fetch_assoc($sql3);
                                                                                        $bank = $data3['cash_in_hand2'];
                                     ...
                                     <div class="text-right record-cash-btn">
                                         <!-- only show button to admin -->

                                         <span class="btn btn-primary btn-sm" style="position: relative; left: 132px; top: 10px" data-toggle="modal" data-target="#record_cash_entry">
                                             <!-- button to record cash in hand to cash book -->
                                             Record <i class="fa fa-arrow-right"></i>
                                         </span>

                                     </div>
                                 </div>
                                 <hr>
                                 <div class="modal fade text-left" id="record_cash_entry" tabindex="-1" role="dialog" aria-labelledby="myModalLabel13" style="display: none;" aria-hidden="true">
                                     <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg " role="document">
                                         <div class="modal-content">
                                             <div class="modal-header bg-primary text-light">
                                                 <h3 class="modal-title" id="myModalLabel13">Record Cash and bank</h3>
                                             ...
                                             <div class="modal-body">
                                                 <form action="operations/record_cash_entry.php" method="post">
                                                     <div class="form-group row">

                                                         <div class="col-md-6">
                                                             <label class="text-body">Cash Amount</label>
                                                             <fieldset class="form-group mb-3">
                                                                 <input type="text" name="cash_amount" required="" readonly class="form-control" placeholder="Cash Amount *" value="<?php echo round($cash_only); ?>">
                                                             </fieldset>
                                                         </div>
                                                         <div class="col-md-6">
                                                             <label class="text-body">Bank Amount</label>
                                                             <fieldset class="form-group mb-3">
                                                                 <input type="text" name="bank_amount" required="" readonly class="form-control" placeholder="Bank Amount *" value="<?php echo round($bank); ?>">
                                                             </fieldset>
                                                         </div>
                                                         <div class="col-md-6">
                                                             <label class="text-body">Date</label>
                                                             <fieldset class="form-group mb-3">
                                                                 <input type="date" class="form-control" name="date" required="" value="<?php echo $date; ?>" readonly>
                                                     ...
                                                     <div class="form-group row">
                                                         <div class="col-md-12">
                                                             ...
                                                             <fieldset class="form-group mb-3">
                                                                 <textarea name="remarks" class="form-control" placeholder="Enter Remarks" rows="4"></textarea>
                                                             </fieldset>
                                                         </div>



                                                         <div class="alert alert-danger col-md-8 ml-2">
                                                             <strong>Note:</strong> Cash and bank will be 0 after recording the amount.
                                                         </div>
                                                         <div class="form-group row justify-align-content-center mb-0">

                                                         </div>
                                                         <div class="col-md-6 text-right ml-4">
                                                             <button type="submit" name="record_cash_entry" class="btn btn-primary btn-lg" style="font-size: 1.2rem;">Record</button>
                                                         </div>
                                                     </div>
                                                 </form>
                                             </div>
                                 ...
                                 <div class="content">
                                     ...
                                     <h5 class="number"><?php
                                                        ...
                                                        $sql3 = mysqli_query($conn, "SELECT SUM(d_amount-c_amount) as cash_in_hand FROM `tbl_trans_detail` WHERE LEFT(acode, 9) in('100100000') and parent_id='$parent_id'");
                                 ...
                                 <div class="icon"><i class="fa fa-money"></i> </div>
                                 <div class="content">
                                     <div class="text">Cash at Bank</div>
                                     <h5 class="number"><?php
                                                        $sql = mysqli_query($conn, "SELECT branch_id, created_by  FROM users where user_id='$userid'");
                                                        $data = mysqli_fetch_assoc($sql);
                                                        $branch_id = $data['branch_id'];
                                                        ...
                                                        $sql3 = mysqli_query($conn, "SELECT SUM(d_amount-c_amount) as cash_at_bank FROM `tbl_trans_detail` WHERE LEFT(acode, 6)='100500' and parent_id='$parent_id' and date(created_date)<='$date_today'");

                                                        $data3 = mysqli_fetch_assoc($sql3);
                                                        $cash_at_bank = $data3['cash_at_bank'];

                                                        $sql4 = mysqli_query($conn, "SELECT  opening_bal FROM `tbl_account` WHERE LEFT(acode, 6)='100500'");

                                                        $data4 = mysqli_fetch_assoc($sql4);
                                                        $opening_bal_bank = $data4['opening_bal'];


                                                        $cash_now_bank = $opening_bal_bank + $cash_at_bank;




                                                        if ($cash_now) {
                                                            echo number_format($cash_now_bank, 0, ".", ",");
                                                        } else {
                                                            echo  "RS - 0";
                                                        }
                                                        ?></h5>
