                                    ...
                                    <table class="table table-hover js-basic-example dataTable table-custom m-b-0" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            while ($pdata = mysqli_fetch_assoc($sql)) {
                                                ...
                                                if ($payment_type == 'CP') {
                                                    $payment_type_badge = "<span class='badge badge-info' style='font-weight: bold; font-size: 1.2rem; padding:3px'>CP</span>";
                                                } elseif ($payment_type == 'JV') {
                                                    $payment_type_badge = "<span class='badge badge-warning' style='font-weight: bold; font-size: 1.2rem; padding: 3px'>JV</span>";
                                                } else {
                                                    $payment_type_badge = "<span class='badge badge-success' style='font-weight: bold; font-size: 1.2rem; padding: 3px'>CR</span>";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $payment_type_badge; ?></td>
                                                    <td>
                                                        <?php
                                                    ...
                                                    <td>
                                                        <ul class="list-unstyled team-info">
                                                            <li><img src="<?php if ($user_profile != '') {
                                                                                echo $user_profile;
                                                                            } else { ?> assets/images/userdefault.jpg<?php } ?>" data-toggle="tooltip" data-placement="top" title="Created by <?php echo $user_name; ?>" alt="Created by <?php echo $user_name; ?>"></li>
