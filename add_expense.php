            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Add Expenses</h2>
                        <ul class="breadcrumb">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="body">
                            ...
                            $customer_edit = mysqli_query($conn,"SELECT * FROM tbl_expense where id='$edit_id'   ");
                                $row = mysqli_fetch_assoc($customer_edit);  
                                $expenses=$row['expense']; 
                               ?>
                                <form action="operations/add_expense.php" method="post"  enctype="multipart/form-data">
                            <div class="row clearfix">
                                   <label class="col-md-2 text-right">Expense</label>
                                <div class="col-md-5 col-sm-12">
                                    <div class="form-group">
                                        <input type="text" name="expenses" class="form-control" placeholder="Expense" value="<?php echo $expenses; ?>">
                            ...
                            <div class="col-md-9 text-center">
                                <button type="submit" name="addexpenses" class="btn btn-primary text">Add Expense</button>
