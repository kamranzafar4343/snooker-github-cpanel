            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Purchase Req Report</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>                            
                            <li class="breadcrumb-item">Purchase Req Report</li>
                        ...
                        <div class="row">
                            <div class="invoice-top clearfix col-md-12">
                                ...
                                <div class="info text-center col-md-12" style="margin-top: 1%;" >
                                    ...
                                    <h3  class="text-center">Purchase Req Report</h3>
                         ...
                         <form  action="req_single.php" method="post" enctype="multipart/form-data" id='form1'>
                        <div class="body">
...
else
{
  ...
  $where_items=" and  tbl_purchase_req_detail.product='$items'";
...
else
{
    ...
    $where_branch='and tbl_purchase_req.parent_id="'.$branch.'"';

}
$location=$_GET['location'];

if($req_item_id && $location!='1')
{
    if($location!='0')
    {
     $bsql=mysqli_query($conn,"SELECT tbl_purchase_req_detail.*,tbl_purchase_req.*,tbl_items.* From tbl_purchase_req_detail inner join tbl_purchase_req on tbl_purchase_req_detail.purchase_req_id=tbl_purchase_req.purchase_req_id inner join tbl_items on tbl_purchase_req_detail.product=tbl_items.item_id where  tbl_purchase_req_detail.product='$items' and tbl_purchase_req_detail.parent_id='$location' and tbl_purchase_req_detail.qty_rec!=''  group by tbl_purchase_req_detail.purchase_req_id order by DATE(tbl_purchase_req.created_date) asc");
    }
    else
    {
         $bsql=mysqli_query($conn,"SELECT tbl_purchase_req_detail.*,tbl_purchase_req.*,tbl_items.* From tbl_purchase_req_detail inner join tbl_purchase_req on tbl_purchase_req_detail.purchase_req_id=tbl_purchase_req.purchase_req_id inner join tbl_items on tbl_purchase_req_detail.product=tbl_items.item_id where  tbl_purchase_req_detail.product='$items' and tbl_purchase_req_detail.qty_rec!=''  group by tbl_purchase_req_detail.purchase_req_id order by tbl_purchase_req.created_date asc");
    }
}
else if($req_item_id && $location=='1')
{
  $bsql=mysqli_query($conn,"SELECT tbl_purchase_req_detail.*,tbl_purchase_req.*,tbl_items.* From tbl_purchase_req_detail inner join tbl_purchase_req on tbl_purchase_req_detail.purchase_req_id=tbl_purchase_req.purchase_req_id inner join tbl_items on tbl_purchase_req_detail.product=tbl_items.item_id where  tbl_purchase_req_detail.product='$items' and tbl_purchase_req_detail.qty_rec!=''  group by tbl_purchase_req_detail.purchase_req_id order by tbl_purchase_req.created_date asc");
}
else
{
  ...
  $bsql=mysqli_query($conn,"SELECT tbl_purchase_req_detail.*,tbl_purchase_req.*,tbl_items.* From tbl_purchase_req_detail inner join tbl_purchase_req on tbl_purchase_req_detail.purchase_req_id=tbl_purchase_req.purchase_req_id inner join tbl_items on tbl_purchase_req_detail.product=tbl_items.item_id where  DATE(tbl_purchase_req.created_date) between '$f_date' and '$t_date' $where_items  $where_cat $where_branch  group by tbl_purchase_req_detail.purchase_req_id order by DATE(tbl_purchase_req.created_date) asc");
}    
...
while($value = mysqli_fetch_assoc($bsql))   
 ...
 $count++;
  ?>
                            ...
                            <td><a href="pur_req_detail.php?u_id=<?php echo $purchase_req_id ?>" target="_blank"><?php echo $count;?></a></td>
      ...
      buttons: [
        {
          ...
          text: '<?php echo $c_name;?>',
           title: '<?php echo $c_name;?> (Purchase Req Report)',
    ...
    var cat_id = $('#cat_id').val();
      ...
      $.ajax({
                ...
                .done(function(response){
                   ...
                   // alert(len)
                     $("#item_id").empty();
                     $("#item_id").append("<option value='All'>All Items</option>");
                        for( var i = 0; i<len; i++){
