                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Add Direct Transfer GRN</li>
                        </ul>
                    </div>            
                                      ...
                                      ?>
                                        <select class="form-control po"  name="po" onchange="get_detail();" >
                                          <option selected="" value="">-- Chose One --</option>
                                           <?php
                                            $sql="SELECT * FROM tbl_purchase_req where stock_receive_status='Pending' and item_transfer!='' and iemi='0' and transfer_type='1' and created_by='$userid'"; 
                                            foreach ($conn->query($sql) as $row){
...
var po=$('.po').val();
  ...
  $.ajax({
                url: "operations/add_req_grn_gen.php",
                type: "POST",
                data: { 
                    po : po
                },
