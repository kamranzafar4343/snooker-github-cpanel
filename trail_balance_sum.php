                                        ...
                                        <table id="example" class="display table table-bordered table-striped" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-b-0 m-t-10 text-center"><?php echo $account['aname']; ?></h6>
                                                        </td>
                                                        <td><span class="m-b-0 m-t-6 text-right"><?php echo number_format($account['opening'], 2); ?></span></td>
                                                        <td><span class="m-b-0 m-t-6 text-right"><?php echo number_format($account['debit'], 2); ?></span></td>
                                                        <td><span class="m-b-0 m-t-6 text-right"><?php echo number_format($account['credit'], 2); ?></span></td>
                                                        <td><span class="m-b-0 m-t-6 text-right"><?php echo number_format($account['closing'], 2); ?></span></td>
                                                    </tr>
                                                <?php endforeach; ?>

                                                <tr class="table-info">
                                                    <td>
                                                        <h4 class="m-b-0 m-t-10"><b>Retained earnings</b></h4>
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                                    <td></td>
                                                ...
                                                <tr class="table-success">
                                                    <td>
                                                        <h4 class="m-b-0 m-t-10"><b>Totals</b></h4>
                                                    </td>
                                                    <td></td>
                                                    <td>
                                                        <h6 class="m-b-0 m-t-6"><?php echo number_format($total_debit, 2); ?></h6>
                                                    </td>
                                                    <td>
                                                        <h6 class="m-b-0 m-t-6"><?php echo number_format($total_credit, 2); ?></h6>
                                                    </td>
                                                    <td>
                                                        <h6 class="m-b-0 m-t-6"><?php echo number_format($total_closing, 2); ?></h6>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
