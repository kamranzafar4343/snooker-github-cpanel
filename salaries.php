                ...
                <table class="table table-hover js-basic-example dataTable table-custom table-striped m-b-0 c_list">
                  ...
                  <tbody>
                    ...
                    while ($data = mysqli_fetch_assoc($sql)) {
                      ...
                      $sql2 = mysqli_query($conn, "SELECT SUM(bonus) as bonus FROM tbl_bonus where emp_id='$id' and MONTH(created_date)=MONTH(CURRENT_DATE())");
                      ...
                      <tr>
                        ...
                        <td>
                          <?php if ($salary > 0 && $salary != '') { ?>
                            ...
                            <a href="#" data-toggle="modal" data-target="#advance<?php echo $id; ?>" class="btn btn-sm btn-info" title="Advance"><i class=" icon-envelope-open"></i> Advance</a>
                            <a href="#" data-toggle="modal" data-target="#bonus<?php echo $id; ?>" class="btn btn-sm btn-danger" title="Bonus"><i class=" fa fa-dollar"></i> Bonus</a>
                                    ...
                                    <form action="operations/advance.php" method="post" enctype="multipart/form-data">
                                      <div class="row clearfix">
                                        <div class="col-md-12 col-sm-12">
                                          ...
                                          <?php
                                          $date_yesterday = date('Y-m-d', strtotime('-1 day')); // Calculate yesterday's date
                                          $date_now = date('Y-m-d'); // Today's date
                                          ?>
                                          <input type="date" class="form-control" name="created_date" id="created_date"
                                            <?php if ($privilige == 'superadmin') { ?>
                                            min=""
                                            value="<?php echo $date_now; ?>"
                                            <?php } elseif ($privilige == 'Manager') { ?>
                                            min="<?php echo $date_yesterday; ?>"
                                            max="<?php echo $date_now; ?>"
                                            value="<?php echo $date_now; ?>"
                                            <?php } else { ?>
                                            min="<?php echo $date_now; ?>"
                                            value="<?php echo $date_now; ?>"
                                            <?php } ?>>
                                        </div>
                                        <div class="col-md-12 col-sm-12">
                            ...
                            <div id="bonus<?php echo $id; ?>" class="modal fade" role="dialog">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-body">

                                    <form action="operations/bonus.php" method="post" enctype="multipart/form-data">
                                      <div class="row clearfix">

                                        <div class="col-md-12 col-sm-12">
                                          <label>Bonus</label>
                                          <input type="text" class="form-control calculate " maxlength="7" name="bonus" id="bonus" required="" style="border-width: 3px; border-style: transparent;"></input>
                                          <input type="hidden" name="emp_id" value="<?php echo $id; ?>"></input>
                                        </div>
                                        <div class="col-md-12 col-sm-12">
                                          <label>Remarks</label>
