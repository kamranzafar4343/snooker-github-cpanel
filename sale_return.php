  ...
  <div id="main-content">
    <div class="container-fluid">
      ...
      if (isset($_GET['sale_id'])) {
        ...
        $get_purchase_total = mysqli_query($conn, "SELECT SUM(purchase_amount) AS purchase_total FROM tbl_sale_detail WHERE sale_id='$sale_id'");
        $data99 = mysqli_fetch_assoc($get_purchase_total);
        $total_purchase = $data99['purchase_total']; // Correct key name
      }
      ?>
                ...
                <div class="row clearfix">
                  ...
                  <div class="col-md-4 col-sm-12">
                    ...
                    <div class='col-md-12 col-sm-4'>
                      ...
                      <div class="form-group">
                        <?php if ($userid == '1') { ?>
                          <input type="date" name="process_date" required="" class="form-control" placeholder="Manual Invoice Date" value="<?php if ($date) {
                                                                                                                                              echo $date;
                                                                                                                                            } else { ?><?php echo $date;
                                                                                                                                                                            } ?>">
                        <?php } else if ($P == '1' && $userid != '1') { ?>
                          <input type="date" name="process_date" id="process_date" class="form-control" placeholder="Manual Invoice Date" value="<?php if ($date) {
                                                                                                                                                    echo $date;
                                                                                                                                                  } else { ?><?php echo $date;
                                                                                                                                                                                  } ?>">
                        <?php } else { ?>
                  ...
                  <div class="col-md-4 col-sm-12">
                    ...
                    <div class='col-md-12 col-sm-4'>
                      ...
                      <div class="form-group">
                        ...
                        <!-- send the discount and total tax -->
                        <input type="hidden" name="discount" id="disc" required="" value="<?php echo $discount; ?>" readonly="" class="form-control">
                        <input type="hidden" name="total_tax" id="total_tax" required="" value="<?php echo $total_tax; ?>" readonly="" class="form-control">
                        <input type="hidden" name="total_purchase" id="total_purchase" required="" value="<?php echo $total_purchase; ?>" readonly="" class="form-control">
                        <input type="hidden" name="gross_amount1" id="gross_amount1" required="" value="<?php echo $gross_amount; ?>" readonly="" class="form-control">
