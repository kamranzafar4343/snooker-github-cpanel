	    ...
	    <div class="container-fluid">
			<div class="row" >
				<div class="col-xl-4 order-xl-first order-last " >
					<div class="card card-custom gutter-b bg-default border-0" style="max-height: 85%;">
							...
							<div class="card-body">
								...
								<div class="d-flex justify-content-between colorfull-select" style="max-width: 100%;">
									<div class="selectmain">
										...
										<select class="form-control" id="customer" name="customer"  onchange="delete_order();" style="max-width: 100%;">
								...
								<div class="d-flex flex-column selectmain">
									<label class="text-dark d-flex" >Date </label>
									<select class="form-control" name="created_date" style="width: 100%">
										<option value="<?php echo $date_prev; ?>"><?php echo $date_prev; ?></option>
										<option value="<?php echo $date; ?>" selected><?php echo $date; ?></option>
										<option value="<?php echo $date_next; ?>"><?php echo $date_next; ?></option>
									</select>
	...
	if(over_selling=='0')
	{
      ...
      //$("#amount_"+row).val(total);
     	...
     	$.ajax({
                ...
                data: {tr_id:tr_id, ref_id:ref_id, qty:qty, rate:rate, amount:amount, stock:stock, over_selling:over_selling},             
                })
                .done(function(response){
