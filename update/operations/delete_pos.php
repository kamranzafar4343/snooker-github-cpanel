...
$brand_name=$value2['cat_name'];
     	      echo '                
                    ...
                    <tr id="row_'.$i.'">
                        <td><input type="text" name="product_name[]" id="product_name_'.$i.'" required readonly class="form-control" value="'.$brand_name." ".$item_name.'"><input type="hidden" name="product[]" id="product_'.$i.'" required readonly class="form-control item_id" value="'.$item_id.'">
                        </td>
