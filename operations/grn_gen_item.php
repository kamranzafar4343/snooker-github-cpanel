...
// {
  $i++;
      ...
      echo '                
                        ...
                        <td><input type="text"  name="item_serial[]" id="item_serial_'.$i.'" class="form-control item_serial"  value="" onchange="chkprodser('.$i.')"></td>
                        <td><input type="text"  name="barcode[]"  id="barcode_'.$i.'" class="form-control barcode"  value="" onchange="chkbar('.$i.')"></td>
