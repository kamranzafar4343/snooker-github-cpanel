                        ...
                        <div class="row">
                            <div class="invoice-top clearfix col-md-12">
                                ...
                                <div class="info text-center col-md-12" style="margin-top: 1%;" >
                                    ...
                                    <h3  class="text-center">Day Close Report</h3>
...
$sql=mysqli_query($conn, "SELECT SUM(opening_cash) as opening_bal FROM tbl_account_lv2 where Left(acode, 6)='100100' and ".$created_by."='$userid'");
$data=mysqli_fetch_assoc($sql);
...
$sql=mysqli_query($conn, "SELECT SUM(opening_bal) as opening_bal FROM tbl_account_lv2 where Left(acode, 6)='500200' and ".$created_by."='$userid'");
$data=mysqli_fetch_assoc($sql);
$opening_bal_expense = $data['opening_bal'];


$sql1=mysqli_query($conn, "SELECT SUM(d_amount-c_amount) as expense FROM tbl_trans_detail where Left(acode, 6)='500200' and created_date < '$f_date' and  ".$created_by."='$userid'");
$data1=mysqli_fetch_assoc($sql1);
$open_expense = $data1['expense'];

$open_expense_total=($opening_bal_expense+$open_expense);

$sql=mysqli_query($conn, "SELECT SUM(opening_bal) as opening_bal FROM tbl_account_lv2 where Left(acode, 6)='500100' and ".$created_by."='$userid'");
$data=mysqli_fetch_assoc($sql);
$opening_bal_salary = $data['opening_bal'];


$sql1=mysqli_query($conn, "SELECT SUM(d_amount-c_amount) as salary FROM tbl_trans_detail where Left(acode, 6)='500100' and created_date < '$f_date'  and ".$created_by."='$userid'");
$data1=mysqli_fetch_assoc($sql1);
...
$sql1=mysqli_query($conn, "SELECT SUM(d_amount) as revenue FROM tbl_trans_detail where Left(acode, 6) IN('300100') and DATE(created_date)  between '$f_date' and '$t_date' and ".$created_by."='$userid'");
$data1=mysqli_fetch_assoc($sql1);
$today_revenue = $data1['revenue'];

$sql1=mysqli_query($conn, "SELECT SUM(d_amount) as revenue FROM tbl_trans_detail where Left(acode, 9) IN('300100100') and DATE(created_date)  between '$f_date' and '$t_date' and ".$created_by."='$userid'");
$data1=mysqli_fetch_assoc($sql1);
$today_cash_revenue = $data1['revenue'];

$sql1=mysqli_query($conn, "SELECT SUM(d_amount) as revenue FROM tbl_trans_detail where Left(acode, 9) IN('300100300') and DATE(created_date)  between '$f_date' and '$t_date' and ".$created_by."='$userid'");
$data1=mysqli_fetch_assoc($sql1);
...
$sql1=mysqli_query($conn, "SELECT SUM(d_amount-c_amount) as rec_bal FROM tbl_trans_detail where Left(acode, 6)='100200' and created_date between '$f_date' and '$t_date'  and ".$created_by."='$userid'");
$data1=mysqli_fetch_assoc($sql1);
$rec_bal_today = $data1['rec_bal'];

$sql1=mysqli_query($conn, "SELECT SUM(d_amount-c_amount) as payable FROM tbl_trans_detail where Left(acode, 6)='200200' and DATE(created_date) between '$f_date' and '$t_date' and ".$created_by."='$userid'");
$data1=mysqli_fetch_assoc($sql1);
$today_payable = abs($data1['payable']);

$sql1=mysqli_query($conn, "SELECT SUM(d_amount-c_amount) as expense FROM tbl_trans_detail where Left(acode, 6)='500200' and created_date between '$f_date' and '$t_date'  and  ".$created_by."='$userid'");
$data1=mysqli_fetch_assoc($sql1);
$today_expense = $data1['expense'];

$sql1=mysqli_query($conn, "SELECT SUM(d_amount-c_amount) as salary FROM tbl_trans_detail where Left(acode, 6)='500100' and created_date between '$f_date' and '$t_date'  and ".$created_by."='$userid'");
$data1=mysqli_fetch_assoc($sql1);
$today_salary = $data1['salary'];

$sql1=mysqli_query($conn, "SELECT SUM(discount) as today_discount FROM tbl_sale where  created_date between '$f_date' and '$t_date'  and ".$created_by."='$userid'");
$data1=mysqli_fetch_assoc($sql1);
$today_discount = $data1['today_discount'];

$sql1=mysqli_query($conn, "SELECT SUM(gross_amount) as today_pur FROM tbl_purchase where  created_date between '$f_date' and '$t_date'  and ".$created_by."='$userid'");
$data1=mysqli_fetch_assoc($sql1);
...
$total_today=round($today_assets-$today_liabilities,0);
///////////////////////////////////////////////////////////////////////////
                                                ...
                                                <table id="example" class="display" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><h7 class="m-b-0 m-t-6"><?php echo number_format($today_return);?></h7></td> 
                                                        </tr>
                                                         <tr>
                                                            <td><h5 class="m-b-0 m-t-10">Receivable</h5></td>
                                                            <td><h7 class="m-b-0 m-t-6"><?php echo number_format($rec_bal_today);?></h7></td> 
                                                        </tr>
                                                         <tr>
                                                            <td><h5 class="m-b-0 m-t-10">Payables</h5></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><h7 class="m-b-0 m-t-6"><?php echo number_format($total_today);?></h7></td> 
                                                        </tr>
...
$(document).ready(function() {
      ...
      buttons: [
          ...
          text: '<?php echo $c_name;?>',
           ...
           title: '<?php echo $c_name;?> (Day Close Report)',
