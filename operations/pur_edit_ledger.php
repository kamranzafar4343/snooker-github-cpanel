...
include "../includes/session.php";
	...
	$sql=mysqli_query($conn, "SELECT * FROM tbl_purchase where purchase_id='$edit_id'");
                  ...
                  {
                  	header('Location: ../edit_ledger.php?updated=wrong&invoice_no='.$invoice_no.'&acode='.$vendor_id.'&created_at='.$date.'');
...
{
	$narration="Amount Paid Against ".$PO." # ".$tranid." Net Amount was ".$net_amount." Amount Payed was ".$total_amt." Payment Date was ".$created_date." GRN Date was ".$invoice_date." ( Edit Narration  ".$new_narration." )";
	
}	
else
{
	$narration="Amount Paid Against ".$PO." # ".$tranid." Net Amount was ".$net_amount." Amount Payed was ".$total_amt." Amount Remaining was ".$amount_remaining." Payment Date was ".$created_date." GRN Date was ".$invoice_date." ( Edit Narration  ".$new_narration." )";
}
...
$invoice_no="Purchase"."_".$edit_id;
			...
			$narration1 ="Amount paid to Vendor against ".$PO." # ".$tranid." was ".$amount_payed." Transaction Date was ".$created_date."  Stock Received on ".$invoice_date." ( Edit Narration  ".$new_narration." )";
			$narration2 ="Payment Cleared to Vendor against ".$PO." # ".$tranid." is ".$amount_payed." Transaction Date was ".$created_date." ( Edit Narration  ".$new_narration." )";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////            	
	...
	if($sql){
		header('Location: ../edit_ledger.php?updated=done&invoice_no='.$invoice_no.'&acode='.$vendor_id.'&created_at='.$date.'');
