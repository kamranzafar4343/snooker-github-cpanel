...
$qty_new = $_POST['qty'];
$stock = $_POST['stock'];
$sale_rate = $_POST['rate'];
$amount = $_POST['amount'];
$over_selling = $_POST['over_selling'];
if($over_selling=='0')
{
if($qty_new>$stock)
{
...
$created_by = $userid;
    ...
    $sql_check=mysqli_query($conn, "UPDATE tbl_sale_temp SET qty='$qty_new', sale_rate='$sale_rate', amount='$amount', stock='$stock' where ref_id='$ref_id' and temp_id='$tr_id' and user_id='$created_by'");
...
$brand_name=$value2['catagory_name'];
     	      ...
     	      echo ' 
                    <tr id="row_'.$i.'">
                        <td><input type="text" name="product_name[]" style="font-size: 16px; font-weight: 700; font-family: sans-serif;" id="product_name_'.$i.'" required readonly class="form-control" tabindex="-1" value="'.$brand_name." ".$item_name.'"><input type="hidden" name="product[]" id="product_'.$i.'" required readonly class="form-control item_id" value="'.$item_id.'">
                        </td>
                    	...
                    	<td><input type="text" tabindex="-1" name="rate[]" style="font-size: 16px; font-weight: 700; font-family: sans-serif;" id="rate_'.$i.'"  class="form-control" value="'.$sale_rate.'" onchange="getTotal('.$i.', '.$temp_id.')"></td>
                    	<td><input type="text" name="amount[]" style="font-size: 16px; font-weight: 700; font-family: sans-serif;" id="amount_'.$i.'" class="form-control" readonly tabindex="-1" value="'.$amount.'"></td>
