...
error_reporting(0);
     ...
     while($row = mysqli_fetch_array($result) ){
                        ...
                        $barcode = $row['barcode'];
                           $query1 = mysqli_query($conn,"SELECT return_qty, return_amount FROM tbl_purchase_return_detail where product='$product' and  purchase_id='$po'"); 
      ...
      echo '                
                        ...
                        <td><input type="text"  readonly="" name="item_serial[]" id="item_serial_'.$i.'" class="form-control" required value="'.$item_serial.'"></td>
                        <td><input type="text"  readonly="" name="barcode[]" id="barcode_'.$i.'" class="form-control" required value="'.$barcode.'"></td>
                        <td><input type="text"  name="return_qty[]" id="return_qty_'.$i.'" class="form-control calculate"  onchange="getTotal('.$i.')" value="'.$return_qty.'"></td>
                        ...
                        <td>
                          <input type="text" readonly="" name="return_amount[]" id="return_amount_'.$i.'" class="form-control"  autocomplete="off" readonly="" value="'.$return_amount.'">
