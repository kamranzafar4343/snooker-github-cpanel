...
if ($edit_id != '') {
	...
	$sql = mysqli_query($conn, "INSERT INTO tbl_trans(vendor_id, invoice_no, narration, total_amount, amount_payed, v_type, bill_status , payment_status, bank_id, check_no, payment_method, created_date, created_by, parent_id) VALUES ('$vendor_id', '$invoice_no', '$narration', '$net_amount', '$total_amt',  '$v_type', 'Completed', '$payment_status', '$bank_id', '$check_no','$payment_method', '$invoice_date', '$userid','$parent_id')");
	...
	$sql = "INSERT INTO tbl_trans_detail (trans_id, invoice_no, acode, d_amount, c_amount, bill_status, narration,  created_date, created_by,parent_id) VALUES ('$tran_id', '$invoice_no', '$vendor_id','$amount_payed', '0.00','Pending', '$narration2', '$invoice_date', '$created_by', '$parent_id')";
	mysqli_query($conn, $sql);

	$sql = "INSERT INTO tbl_trans_detail (trans_id, invoice_no,  acode, d_amount, c_amount, bill_status, narration,  created_date, created_by,parent_id) VALUES ('$tran_id', '$invoice_no', '$acode', '0.00', '$amount_payed','Pending','$narration1', '$invoice_date', '$created_by', '$parent_id')";
	mysqli_query($conn, $sql);
