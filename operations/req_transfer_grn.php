...
if($edit_id!='')
{
		  ...
		  for ($a = 0; $a < count($_POST["qty"]); $a++)
        {
            ...
            mysqli_query($conn, $sql);
              ...
              $sql=mysqli_query($conn, "Update tbl_purchase_detail set transfer='1' WHERE product='" . $_POST["product"][$a] . "' and  item_serial='" . $_POST["item_serial"][$a] . "' and  pur_item_id='" . $_POST["pur_item_id"][$a] . "'");
...
////////////////////////////////////////////////////////////////// Accounts //////////////////////////////////////////////////////////////      
	...
	$narration=" PR # ".$tranid." PR Date was ".$invoice_date." Stock Qty Recieved on ".$created_date." was ".$item_recieved." and Total Qty was ".$item_total."";
	$v_type='ST';
...
$bill_status='Transfered';
	...
	if($sql){
		header('Location: ../purchase_req_list.php?stock=done');
	}
