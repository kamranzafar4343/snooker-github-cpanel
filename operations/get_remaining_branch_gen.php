...
pur_item_id NOT IN (SELECT 
 ...
 AND pur_item_id NOT IN (SELECT 
  ...
  AND tbl_purchase_req_detail.recieved!='0' and tbl_purchase_req_detail.iemi='0' and tbl_purchase_req_detail.product='$itemid' and tbl_purchase_req_detail.transfer='0' $created");
