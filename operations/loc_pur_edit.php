...
include "../includes/session.php";
	...
	$sql=mysqli_query($conn, "SELECT * FROM tbl_single_purchase where purchase_id='$edit_id'");
                  ...
                  // {
                  // 	header('Location: ../single_purchase.php?updated=wrong');
                  // 	exit();
                  // }
...
if($edit_id!='')
{
	 	...
	 	$sql=mysqli_query($conn, "UPDATE single_purchase SET   amount_payed='$new_amount', amount_remaining='$amount_remaining', payment_status='$payment_status', payment_date='$created_date', created_by='$created_by' where purchase_id='$edit_id'");
...
{
	$narration="Amount Paid Against Local ".$PO." # ".$tranid." Net Amount was ".$net_amount." Amount Payed was ".$total_amt." Payment Date was ".$created_date." GRN Date was ".$invoice_date."";
	
}	
else
{
	$narration="Amount Paid Against Local ".$PO." # ".$tranid." Net Amount was ".$net_amount." Amount Payed was ".$total_amt." Amount Remaining was ".$amount_remaining." Payment Date was ".$created_date." GRN Date was ".$invoice_date."";
}
