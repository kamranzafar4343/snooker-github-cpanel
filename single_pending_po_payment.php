                                      ...
                                      ?>
                                        <select class="form-control po"  name="po" onchange="get_detail();" >
                                          <option selected="" value="">-- Chose One --</option>
                                           <?php
                                            $sql="SELECT * FROM tbl_single_purchase where payment_status='Pending' and amount_payed!='' and created_by='$userid' and iemi='0'"; 
                                            foreach ($conn->query($sql) as $row){
...
var po=$('.po').val();
  ...
  $.ajax({
                url: "operations/get_single_item_loc_pay.php",
                type: "POST",
                data: {
                    po : po
                },
