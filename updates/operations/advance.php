...
$sql=mysqli_query($conn, "INSERT INTO tbl_salary(staff_mem_id, staff_mem_salary, remarks, created_date, created_by) VALUES ('$staff_mem_id', '$staff_mem_salary', '$remarks', '$created_date', '$userid')");
