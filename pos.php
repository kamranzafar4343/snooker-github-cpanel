...
<head>
    ...
    /* font size of select 2 product search results text */
    ...
    /* disabled table buttons css */
    /* This class will be applied when the table is occupied */
    .disabled-table {
        ...
        opacity: 0.5;
        /* Reduce the opacity to give a "disabled" look */
        pointer-events: none;
        /* Disable clicking or interaction with the table */
    }

    /* This style will change the label's background when the table is disabled */
    input:disabled+label {
        background-color: #f2f2f2;
        /* Grey out the background */
        border: 1px solid #ccc;
        /* Optional: add border for disabled state */
        color: grey;
        /* Change the label text color to grey */
    }
    </style>
    <?php
	error_reporting(0);
...
<body id="tc_body" class="header-fixed header-mobile-fixed subheader-enabled aside-enabled aside-fixed"
    style="background: <?php echo $color; ?> !important; ">
                    ...
                    <div class="topbar-item folder-data">
                        ...
                        <div class="topbar justify-content-end">
                            <div class="btn btn-icon  w-auto h-auto btn-clean d-flex align-items-center py-0 mr-3"
                                id="dinein_model" data-toggle="modal" data-target="#dinein_items">
                                <a href="#" class='btn btn-sm btn-outline-success'>View Tables Status</a>

                            </div>
                            <a href="index.php" class='btn btn-sm btn-outline-dark mx-1'>Dashboard</a>&nbsp;
                            <a href="pos_sale_list.php" class='btn btn-sm btn-outline-success'>Sale List</a>&nbsp;
                            <div class="dropdown mega-dropdown">
                                <div id="id2" class="topbar-item " data-toggle="dropdown" data-display="static">
                                    <div
                                        class="btn btn-icon w-auto h-auto btn-clean d-flex align-items-center py-0 mr-3">
                                        ...
                                        <span class="symbol symbol-35 symbol-light-success">
                                            <span class="symbol-label bg-primary  font-size-h5 ">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px"
                                                    ...
                                                    <path
                                                        d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2zm2 .5v2a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 .5-.5v-2a.5.5 0 0 0-.5-.5h-7a.5.5 0 0 0-.5.5zM4.5 9a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1zM4 12.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5zM7.5 6a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1zM7 9.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5zm.5 2.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1zM10 6.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5zm.5 2.5a.5.5 0 0 0-.5.5v4a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 0-.5-.5h-1z" />
                                                </svg>
                                            </span>
                                        </span>
                                    </div>
                            ...
                            <div class="topbar-item folder-data">
                                <div class="btn btn-icon  w-auto h-auto btn-clean d-flex align-items-center py-0 mr-3"
                                    id="keys_model" data-toggle="modal" data-target="#folderpopkeys">
                            ...
                            <div class="topbar-item folder-data">
                                <div class="btn btn-icon  w-auto h-auto btn-clean d-flex align-items-center py-0 mr-3"
                                    id="darft_products_model" data-toggle="modal" data-target="#folderpop">
                                    <?php
                                    ...
                                    <span class="badge badge-pill badge-primary"
                                        id="draft_bills"><?php echo $a; ?></span>
                                    <span class="symbol symbol-35  symbol-light-success">
    ...
    <div class="contentPOS">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-4 order-xl-first order-last " style="padding: 0px; padding-right: 12px">
                    <div class="card card-custom gutter-b bg-default border-0" style="max-height: 100%;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-12">
                                    <input class="form-control bag-primary" id="product_search_side"
                                        placeholder="Type to search..." style="max-height: 50px;">
                                </div>
                            </div>
                            <br>
                ...
                <div class="col-xl-5 col-lg-8 col-md-12" style="padding: 0px;">
                    <div class="">
                        <div class="card card-custom gutter-b bg-white border-0 table-contentpos">
                            <div class="card-body">
                                <form action="operations/add_sale_pos.php" method="post" enctype="multipart/form-data">
                                    <div class="d-flex justify-content-left colorfull-select" style="max-width: 100%;">
                                        <div class="selectmain">
                                            <label class="text-dark d-flex"
                                                style="font-size: 16px; font-weight: 800; font-family: sans-serif;">Choose
                                                a Customer
                                                <span class="badge badge-secondary white rounded-circle"
                                                    data-toggle="modal" data-target="#choosecustomer">
                                            ...
                                            <input class="form-control bag-primary " id="over_selling"
                                                value="<?php echo $over_selling; ?>" hidden>
                                            <select class="form-control" id="customer" name="customer"
                                                style="margin-left:10px; width:370px; max-width: 100%; "
                                                onchange="check_discount();">
												...
												foreach ($conn->query($sql) as $row) {
													...
													if ($row['aname'] == 'Walk in Customer' && $edit_id == '' && $ref_id == '') {
														echo "<option value='$row[acode]' selected>$row[aname]</option>";
													} else if ($row['aname'] == 'Blank') {
														echo "<option value='$row[acode]' selected>$row[aname]</option>";
                                        ...
                                        <div class="d-flex flex-column selectmain"
                                            style="margin-bottom: 0px; margin-left: 30px; width: 340px;">
                                            <label class="text-dark d-flex"
                                                style="font-size: 16px; font-weight: 800; font-family: sans-serif;">Ref
                                                # </label>
                                            <input type="text" name="ref_id"
                                                style=" font-size: 16px; font-weight: 800; font-family: sans-serif;"
                                                readonly tabindex="-1" id="ref_id" required readonly
                                                class="form-control" value="<?php echo $ref_id; ?>">
                                            <input type="hidden" name="sales_men" readonly tabindex="-1" id="sales_men"
                                                required readonly class="form-control" value="<?php echo $userid; ?>">
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column selectmain"
                                        ...
                                        <div class="d-flex flex-wrap" id="table-buttons">
                                            <?php
											// Fetch all tables so that user can select any table even when editing
											$sql = "SELECT * FROM tbl_tables where table_id = '32'";

											foreach ($conn->query($sql) as $row) {
												// If editing and the current table matches the selected one, mark it checked
												$checked =  "checked";
												$selectedClass = ($edit_id != '' && $row['table_id'] == $table_id) ? "btn-success" : "btn-primary"; // Change color if selected

												echo "<input type='checkbox' name='table' id='table_$row[table_id]' value='$row[table_id]' style='display:none;' onclick='selectTable(this)' $checked />";
												echo "<label for='table_$row[table_id]' class='btn $selectedClass m-1'><span class='tick'>&#10003;</span> <span class='table-name'>$row[table_name]</span></label>";
											}
											?>
                                        </div>
                            ...
                            <div class="col-md-12" <?php echo $hidden; ?>>
                                <select id="product_search" name="product" style="width: 100%; max-height: 60%"
                                    onchange="add_item();">
                                    <option value="" selected="">Select Item</option>

                                    <?php
									$sql = "SELECT tbl_items.*, tbl_cat.catagory_name, tbl_purchase_detail.*
                                    FROM tbl_items
                                    INNER JOIN tbl_cat ON tbl_items.category = tbl_cat.id
                                    INNER JOIN tbl_purchase_detail ON tbl_items.item_id = tbl_purchase_detail.product
                                    WHERE tbl_purchase_detail.qty_rec != '' ";

									foreach ($conn->query($sql) as $row) {
										$display = "{$row['barcode']} - {$row['catagory_name']} {$row['item_name']}";
										echo "<option value='{$row['item_id']}'>$display</option>";
									}
									?>
                            ...
                            <div class="card-body" style="margin-top: 0px; margin-bottom: -14px;">
                                ...
                                <div class="alert alert-danger" id="customer-alert" style="display: none;">
                                    <strong>Sorry !</strong> for cash sale amount recieved must be equal to total
                                    amount.
                                </div>
                        ...
                        <div class="card card-custom gutter-b bg-white border-0 table-contentpos cart-div">
                            <br>
                                ...
                                <div class="table-responsive">
                                    <table id="product_info_table" class="display" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th
                                                    style="width: 50%; font-size: 16px; font-weight: 800; font-family: sans-serif;">
                                                    Name</th>
                                                <th style="font-size: 16px; font-weight: 800; font-family: sans-serif;">
                                                    Quantity</th>
                                                <th style="font-size: 16px; font-weight: 800; font-family: sans-serif;">
                                                    Rate</th>
                                                <th style="font-size: 16px; font-weight: 800; font-family: sans-serif;">
                                        ...
                                        <table class="table right-table">
                                            ...
                                            <tbody>
                                                <tr class="d-flex align-items-center justify-content-between"
                                                    ...
                                                    <th class="border-0 font-size-h3 mb-0 font-size-bold text-info">
                                                        Total Items
                                                    </th>
                                                    <td
                                                        class="border-0 justify-content-end d-flex text-secondary font-size-base">
                                                        <input type="number" name="total_items" readonly
                                                            id="total_items" tabindex="-1" required readonly
                                                            class="form-control"
                                                            style="background-color: transparent; border: 0px solid; height: 20px; width: 200px; color: black; font-size: 20px;"><input
                                                ...
                                                <tr class="d-flex align-items-center justify-content-between"
                                                    ...
                                                    <th class="border-0 font-size-h2 mb-0 font-size-bold text-danger">
                                                        Subtotal (Rs)
                                                    </th>
                                                    <td
                                                        class="border-0 justify-content-end d-flex text-dark font-size-base">
                                                        <input type="number" name="sub_total" readonly id="sub_total"
                                                            tabindex="-1" required readonly class="form-control"
                                                            style="background-color: transparent; border: 0px solid; height: 25px; width: 200px; color: black; font-size: 25px;">
                                                        <input type="hidden" name="invoice_date"
                                                            value="<?php echo $created_date; ?>">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                            ...
                            <div class="card-body">
                                <div class="form-group row mb-0">
                                    <div class="col-md-12 btn-submit d-flex justify-content-end">
                                        <button type="button" class="btn btn-danger mr-2 confirm-delete" title="Delete"
                                            onclick="delete_order()" style="font-size: 22px;">
                                            <i class="fas fa-trash-alt mr-2"></i>
                                            Suspand/Cancel
                                        </button>
                                        <button type="button" class="btn btn-secondary white" id="draft_order_button"
                                            onclick="draft_order()" style="font-size: 22px;">
                ...
                <div class="col-xl-3 col-lg-4 col-md-12" style="padding: 0px; padding-left: 12px">
                        ...
                        <div class="card-body">
                            ...
                            <div class="resulttable-pos">
                                <table class="table right-table">
                                    ...
                                    <tbody>
                                        <tr class="d-flex align-items-center justify-content-between">
                                            <th class="border-0 font-size-h3 mb-0 font-size-bold text-danger">
                                                Sale Type
                                            </th>
                                            <td class="border-0 justify-content-end d-flex text-dark font-size-base">
                                                <select class="form-control badge-secondary text-white" name="sale_type"
                                                    style="width: 180px; font-size: calc(1rem + 4px); font-weight: 800;"
                                                    id="sale_type" style="width: 180px;" onchange="subAmount();">
                                                    <?php if ($edit_id != '') {
														if ($sale_type == 'Credit') { ?>
                                                    <option
                                                        style="font-size: 18px; font-weight: 800; font-family: sans-serif;">
                                                        Cash</option>
                                                    <option
                                                        style="font-size: 18px; font-weight: 800; font-family: sans-serif;"
                                        ...
                                        <tr>
                                            <input type="hidden" name="total_sale_only" id="total_sale_only" value="">
                                        </tr>
                                        <tr class="d-flex align-items-end justify-content-between"
                                            style="border-top:1px solid #000 !important; <?php echo $hidden_main; ?>">
                                            <th class="border-0 ">
                                                <div
                                                    class="d-flex align-items-center font-size-h4 mb-0 font-size-bold text-dark">
                                                    FIXED DISCOUNT(%)
                                                </div>
                                            </th>
                                            <td class="border-0 justify-content-end d-flex text-dark font-size-base">
                                                <input type="text" name="fixed_discount" id="fixed_discountt"
                                                    class="form-control calculate text-right" readonly=""
                                                    value="<?php echo $fixed_discount; ?>"
                                                    style="background-color: transparent; border: 1px solid; height: 30px; width: 200px; color: black; font-size: 20px; font-weight: 800; ">
                                            </td>

                                        </tr>
                                        <tr class="d-flex align-items-center justify-content-between hidden"
                                            style="border-top:1px solid #000 !important; <?php echo $hidden_main; ?>">
                                            <th class="border-0 font-size-h4 mb-0 font-size-bold text-dark">
                                                Amount after fixed discount(Rs)
                                            </th>
                                            <td class="border-0 justify-content-end d-flex text-dark font-size-base">
                                                <input type="text" name="after_fdiscount" id="after_fdiscount"
                                                    tabindex="-1" readonly class="form-control text-right"
                                                    style="background-color: transparent; border: 0px solid; height: 30px; width: 100px; color: black; font-size: 20px; font-weight: 800; ">
                                            </td>
                                        </tr>
                                        <tr class="d-flex align-items-end justify-content-between"
                                            style="border-top:1px solid #000 !important;   <?php echo $hidden_main; ?>">
                                            ...
                                            <td class="border-0 justify-content-end d-flex text-dark font-size-base">
                                                <input type="text" name="discount" id="discount"
                                                    class="form-control calculate text-right" onchange="subAmount();"
                                        ...
                                        <tr class="d-flex align-items-center justify-content-between"
                                            ...
                                            <td class="border-0 justify-content-end d-flex text-dark font-size-base">
                                                <input type="text" name="after_tax" id="after_tax" tabindex="-1"
                                                    readonly class="form-control text-right" onchange="subAmount();"
                                        ...
                                        <tr class="d-flex align-items-center justify-content-between item-price"
                                            ...
                                            <td class="border-0 justify-content-end d-flex text-primary font-size-base">
                                                <input type="text" name="total_amount" id="total_amount" tabindex="-1"
                                                    required readonly class="form-control text-right"
                                                    style="background-color: transparent; border: 0px solid; height: 30px; width: 100px; color: black; font-size: 20px; font-weight: 800; ">
                                            </td>
                                        ...
                                        <tr class="d-flex align-items-center justify-content-between item-price"
                                            ...
                                            <td
                                                ...
                                                <input type="text" name="total_amount_recieved"
                                                    id="total_amount_recieved" required
                                                    class="form-control calculate text-right"
                                                    value="<?php echo $amount_recieved; ?>" onkeyup="subAmountReturn();"
                                                    onfocus="this.select();"
                                                    style="background-color: transparent; border: 1px solid; height: 30px; width: 200px; color: black; font-size: 20px; font-weight: 800; ">
                                            </td>
                                        ...
                                        <tr class="d-flex align-items-center justify-content-between item-price"
                                            ...
                                            <td class="border-0 justify-content-end d-flex text-primary font-size-base">
                                                <input type="text" name="total_amount_return" id="total_amount_return"
                                                    readonly="" tabindex="-1" required class="form-control text-right"
                                                    value="<?php if ($amount_recieved) {
                            ...
                            <div class="d-flex justify-content-end align-items-center flex-column buttons-cash">
                                <div>
                                    <!-- gif loader	 -->
                                    <div id="loader"
                                        style="display: none; width: 30px; height: 30px; border: 4px solid #f3f3f3; border-top: 4px solid #3498db; border-radius: 50%; animation: spin 1s linear infinite;">
                                    </div>

                                    <button type="submit" class="btn btn-primary white mb-2 submit_form"
                                        id="submit_form" style="font-size: 22px;">
                                ...
                                <div>
                                    <a href="index.php" class="btn btn-success white mb-2" style="font-size: 22px;">
    ...
    <div class="modal fade text-left" id="choosecustomer2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel13"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close rounded-pill btn btn-sm btn-icon btn-light btn-hover-primary m-0"
                        ...
                        <svg width="30px" height="30px" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                ...
                <div class="modal-body">
                    <form action="operations/add_client3.php" method="post">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <fieldset class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="mobile_no1"
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <fieldset class="form-group mb-3">
                                    ...
                                    <input type="text" name="client_cnic" class="form-control"
                            ...
                            <div class="col-md-6">
                                ...
                                <fieldset class="form-group mb-3">
                                    <input type="text" name="client_fathername" class="form-control"
                            ...
                            <div class="col-md-6">
                                ...
                                <fieldset class="form-group mb-3">
                                    <input type="text" name="address_permanent" class="form-control"
                                        placeholder="Customer Permanent Address">
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <label class="text-body">Customer Residential Address</label>
                                <fieldset class="form-group mb-3">
                                    <input type="text" name="address_current" class="form-control"
                                        placeholder="Customer Residential  Address">
                                </fieldset>
                            </div>
                        </div>
    ...
    <div class="modal fade text-left col-sm-12 col-xl-12 col-sm-12" id="folderpopkeys" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg " role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close rounded-pill btn btn-sm btn-icon btn-light btn-hover-primary m-0"
                        data-dismiss="modal" aria-label="Close" id="close_draft1">
                        <svg width="20px" height="20px" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z">
    ...
    <div class="modal fade text-left col-sm-12 col-xl-12 col-sm-12" id="folderpop" tabindex="-1" role="dialog"
        aria-labelledby="myModalLabel14" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg " role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="myModalLabel14">Draft Orders</h3>
                    <button type="button" class="close rounded-pill btn btn-sm btn-icon btn-light btn-hover-primary m-0"
                        data-dismiss="modal" aria-label="Close" id="close_draft">
                        <svg width="20px" height="20px" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="pos-order">
                                ...
                                <div class="d-flex justify-content-end">
                                    <a href="pos.php?ref_id=<?php echo $ref_id_pending; ?>" class="ml-3" title="Edit"><i
                                            class="fas fa-edit"></i></a>
                                    <a href="#" class="ml-3 delete_order_pending" title="Delete"
                                        data-sale="<?php echo $ref_id_pending; ?>"><i class="fas fa-trash-alt"></i></a>
                                </div>
                            </div>
    ...
    <!-- view table status modal -->
    <div class="modal fade text-left col-sm-12 col-xl-12 col-sm-12" id="dinein_items" tabindex="-1" role="dialog"
        aria-labelledby="myModalLabel16" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl"
            style="max-width: 80%; width: 90%; margin-top:45px; margin-bottom:30px;" role="document">
            <div class="modal-content">
                <div
                    class="modal-header d-flex justify-content-between align-items-center bg-light border-bottom border-primary shadow-sm rounded-top px-4 py-3">
                    <h3 class="modal-title fw-bold mb-0 d-flex align-items-center" id="myModalLabel16"
                        style="font-size: 32px; color: black;">

                        View Table Status
                        <button class="btn btn-primary ml-3" data-toggle="modal" data-target="#choosecustomer2">
                            <span class="fa fa-plus"></span> Add Customer
                        </button>

                        <button type="button" class="btn btn-success ml-2"
                            onclick="window.location.href='pos.php?dinein_items=1';"><span class="fa fa-sync"></span>
                            Reload </button>

                        <button type="button" class="btn btn-warning ml-2"
                            onclick="window.location.href='pos_sale_list.php';"></span> Sale List </button>

                    </h3>

                    <button type="button"
                        class="btn btn-sm btn-icon rounded-circle bg-danger text-white border-0 shadow-sm"
                        data-dismiss="modal" aria-label="Close" id="close_draft1">
                        <svg width="35px" height="30px" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z">
                            </path>
                ...
                <div class="modal-body pos-ordermain" style="max-height: 90%; max-width: 100%; ">
                    <div class="row" id="darft_product1">
                        <?php
						$qty = 0;
						$gross_amount = 0;
						$date = date('Y-m-d');
						$sql_table = mysqli_query($conn, "SELECT * FROM tbl_tables");

						// Fetch all tables into an array
						$tables = [];
						while ($row = mysqli_fetch_assoc($sql_table)) {
							$tables[] = $row;
						}

						// Custom order of table IDs
						$customOrder = [31, 25, 30, 24, 29, 23, 28, 22, 27, 21, 26, 43, 37, 42, 36, 41, 35, 40, 34, 39, 33, 38];

						// Reorder tables based on the custom order
						$orderedTables = [];
						foreach ($customOrder as $tableId) {
						...
						// Split tables
						$leftTables = array_slice($orderedTables, 0, 11);
						$rightTables = array_slice($orderedTables, 11);
						?>

                        <div class="row" style="display: flex;">

                            <!-- Left Side (First 12 Tables) -->
                            <div class="col-md-6"
                                style="border-right: 5px dashed #000080; box-shadow: 2px 0px 10px rgba(0,0,0,0.1);">
                                <!-- Stylish border with shadow -->
                                <div class="row">
                                    <?php foreach ($leftTables as $data) {
										$table_id = $data['table_id'];
										$table_name = $data['table_name'];


										$sql_dinein = mysqli_query($conn, "SELECT customer_phone, game_type, remarks, sale_id, customer_name, status, gross_amount, created_date, update_status FROM tbl_sale WHERE sale_type='Credit' AND table_id='$table_id' AND DATE(created_date) >= DATE_SUB(CURDATE(), INTERVAL 1 DAY) AND status='0' ORDER BY sale_id DESC");


										$div_color = "";
										if (mysqli_num_rows($sql_dinein) > 0) {
											$row = mysqli_fetch_assoc($sql_dinein);
											$sale_id = $row['sale_id'];
											$update_status = $row['update_status'];

											$game_type = $row['game_type'];
                                            $status = $row['status']; // Sale status
											$created_date = $row['created_date'];  // Example: '2025-04-10 21:27:10'
											
											  // Default color based on update status
											
											  if ($update_status == 0) {
                                                $div_color = '#3498db'; 
                                            }

											// Calculate how many minutes have passed since sale creation
                                            $created = new DateTime($created_date);
                                            $now = new DateTime();
                                            $minutes_passed = floor(($now->getTimestamp() - $created->getTimestamp()) / 60);

                                          
                                            // Override color if conditions for 30-minute timeout are met
                                            if ($minutes_passed > 30 && $update_status == 0 && $game_type != 'century') {
                                                $div_color = '#FFD6E0'; // Light red/pink to alert
                                            }
								
											$customer_id = $row['customer_name'];
											$cust_query = mysqli_query($conn, "SELECT username FROM tbl_customer WHERE customer_id=$customer_id");
                                    ...
                                    <div class="col-lg-6">
                                        <div class="pos-order"
                                            style="background-color: <?php echo $div_color; ?> !important; padding: 15px;">
                                            <!-- Darker div color for each table -->
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <div class="orderdetail-pos time-and-dropdown-in-modal">
                                                    <h3 class="pos-order-title"
                                                        style="font-weight: 800; color: black; margin-bottom: 10px;">
                                                        <?php echo $table_name; ?></h3>
                                                    <?php if (!empty($div_color)) {
															//if game type is century
															if ($game_type == 'century') {
														?>

                                                    <div class="d-flex justify-content-start">
                                                        <!-- Create a unique ID for each timer in case you show multiple -->
                                                        <?php $uniqueId = 'timer_' . $sale_id; ?>

                                                        <div class="d-flex justify-content-start century-styling">
                                                            <strong style="font-size: 18px; font-weight:800;">
                                                                Century: <span
                                                                    id="<?php echo $uniqueId; ?>">Loading...</span>
                                                            </strong>
                                                        </div>

                                                        <script>
                                                        (function() {
                                                            // Create a new Date object from PHP date (format: YYYY-MM-DD HH:MM:SS)
                                                            ...
                                                            function updateTimer() {
                                                                const now = new Date();
                                                                const diffInSeconds = Math.floor((now -
                                                                    createdDate) / 1000);

                                                                // Calculate full minutes passed
                                                                const minutesPassed = Math.floor(diffInSeconds /
                                                                    60);

                                                                // Display the minutes passed
                                                                display.textContent = `${minutesPassed} min`;
                                                            }
                                                    ...
                                                    <select id="customer_select_<?php echo $sale_id; ?>"
                                                        class="selectpicker form-control mr-2" data-live-search="true"
                                                        style="font-size: 16px; max-width: 70%;">
                                                        <?php
																		$customers = mysqli_query($conn, "SELECT customer_id, username FROM tbl_customer");
																		while ($cust = mysqli_fetch_assoc($customers)) {
																			$selected = ($cust['username'] == $customer_name) ? 'selected' : '';
																			echo "<option value='{$cust['customer_id']}' $selected>{$cust['username']}</option>";
																		}
																		?>
                                                    </select>
                                                    ...
                                                    <div class="d-flex align-items-center mt-2">
                                                        ...
                                                        <button class="btn btn-danger btn-sm"
                                                            ...
                                                            id="update_customer_<?php echo $sale_id; ?>"
                                                            onclick="updateCustomer2(<?php echo $sale_id; ?>)">Close</button>
                                                    </div>
                                                    </p>
                                                    ...
                                                    <?php
															...
															?>
                                                    <p style="color: black;">
                                                    <div class="d-flex justify-content-start frame-styling"
                                                        style="margin-bottom: -6px;  padding-top: 8px;">
                                                        <strong
                                                            style="font-size: 18px; "><?php echo "Frame: " . date("d-m-Y h:i", strtotime($created_date)); ?></strong><br><br>
                                                    </div>
                                                    ...
                                                    <div class="d-flex align-items-center mt-2">
                                                        <!-- cash button -->
                                                        <a href="direct_cash_complete.php?sale_id=<?php echo $sale_id; ?>"
                                                            class="btn btn-dark btn-sm"
                                                            style="font-size: 14px; padding: 5px; margin-right: 5px;"
                                                            title="Cash">Cash</a>
                                                        
                                                                <!-- bank button -->
                                                            <a href="direct_bank_complete.php?sale_id=<?php echo $sale_id; ?>"
                                                        ...
                                                        <button class="btn btn-danger btn-sm"
                                                            style="font-size: 14px; padding: 5px; margin-left: 5px;"
                                                            id="update_customer_<?php echo $sale_id; ?>"
                                                            onclick="updateCustomer(<?php echo $sale_id; ?>)">Close</button><br>
                                                        
                                                            <button class="btn btn-success btn-sm"
                                                            style="font-size: 14px; padding: 5px; margin-left: 5px;"
                                                            id="update_customer_<?php echo $sale_id; ?>"
                                                            onclick="continueFunc(<?php echo $sale_id; ?>)">Continue</button><br>
                                                    </div>
                                                    </p>
                                                    <?php } ?>
                                                    <?php } else { ?>
                                                    <div class="d-flex justify-content-start frame-cent-buttons"
                                                        style="margin-bottom: 24px;">
                                                        <form action="operations/add_sale_pos2.php" method="POST"
                                                            class="mr-2">
                                                            ...
                                                            <button type="submit" class="btn btn-success btn-sm"
                                                                style="font-size: 14px; padding: 4px 10px; margin-top:5px">Frame</button>
                                                        </form>

                                                        <form action="operations/add_sale_pos3.php" method="POST">
                                                            <input type="hidden" name="ref_id"
                                                                value="<?php echo $ref_id; ?>">
                                                            <input type="hidden" name="table_id"
                                                                value="<?php echo $table_id; ?>">
                                                            ...
                                                            <button type="submit" class="btn btn-primary btn-sm"
                                                                style="font-size: 14px; padding: 4px 10px; margin-top:5px">Century</button>
                                                        </form>
                                                    </div>
                            ...
                            <!-- Right Side (Remaining Tables) -->
                            <div class="col-md-6">
                                <div class="row">
                                    <?php foreach ($rightTables as $data) {

										// same logic as above (copy-paste or refactor later)

										$table_id = $data['table_id'];
										$table_name = $data['table_name'];


										$sql_dinein = mysqli_query($conn, "SELECT customer_phone, game_type, status, remarks, sale_id, customer_name, gross_amount, created_date, update_status FROM tbl_sale WHERE sale_type='Credit' AND table_id='$table_id' AND DATE(created_date) >= DATE_SUB(CURDATE(), INTERVAL 1 DAY) AND status='0' ORDER BY sale_id DESC");
                                    ...
                                    <div class="col-lg-6">
                                        <div class="pos-order"
                                            style="background-color: <?php echo $div_color; ?> !important;">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <div class="orderdetail-pos time-and-dropdown-in-modal">
            ...
            <div class="offcanvas-content">
                ...
                <div id="customizer-theme-colors" class="customizer-theme-colors">
                    ...
                    <ul class="list-inline unstyled-list d-flex">
                        ...
                        <li class="color-box mr-2">
                            <div id="color-theme-blue" class="d-flex rounded w-20px h-20px"
                                style="background-color: blue;">
                            </div>
                        </li>
                        <li class="color-box mr-2">
                            <div id="color-theme-red" class="d-flex rounded w-20px h-20px"
        ...
        $(document).ready(function() {
            $('#customer_select_<?php echo $sale_id; ?>').selectpicker();
        });
        </script>
        ...
        $(document).on('keydown', function(e) {
            ...
            //submit with ctrl + s shortcut key and check validations and handle when user press this shortcut key
            if ((e.ctrlKey || e.metaKey) && e.key === 's') {
                ...
                if (tableProductLength === 0) {
                    $("#product-alert").show().fadeTo(4000, 500).slideUp(500);
                    return false; // Stop execution
                }

                // Check if customer is selected
                if (customer === '') {
                    $("#select-alert").show().fadeTo(4000, 500).slideUp(500);
                    return false; // Stop execution
                }
        ...
        $("#submit_form").click(function() {
            ...
            //when submit button is clicked the button will be hidden and the loader gif is displayed for a sec
            let button = $(this);
            let loader = $("#loader"); // The loader element

            button.hide(); // Hide the button
            loader.show(); // Show the loader

            setTimeout(() => {
                loader.hide(); // Hide the loader for 1 second
        ...
        <script>
        //if no table selected show validation
        var table = $('#table-buttons').val();

        function validateTableSelection() {
            if ($("input[name='table']:checked").length == 0) {
                $("#table-alert").show().fadeTo(4000, 500).slideUp(500, function() {
        ...
        // Attach validation to an existing submit button
        ...
        function subAmount() {
            ...
            if (1 > 0) {
                //total sale only
                $("#total_sale_only").val(totalSubAmount);
        ...
        <script type="text/javascript">
        function selectTable(checkbox) {
            const tableId = checkbox.value;
            const hiddenInput = document.getElementById('table');

            // Uncheck all checkboxes except the one that was clicked
            const checkboxes = document.querySelectorAll('#table-buttons input[type="checkbox"]');
            ...
            if (checkbox.checked) {
                ...
                hiddenInput.value = ''; // Clear the hidden input if unchecked
            }

            // Optionally, you can add any additional logic here, such as updating the UI or making an AJAX call
        }
        </script>
        ...
        $(document).ready(function() {
            $('input[name="username"]').on('blur', function() {
                let username = $(this).val(); // Get the entered username

                if (username !== '') {
                    $.ajax({
                        url: 'checkusername.php', // PHP file to handle the check
                        method: 'POST',
                        data: {
                            username: username
                        },
                        success: function(response) {
                            if (response == 'exists') {
                                ...
                                $('button[name="addclientspos"]').prop('disabled', true);
                            } else {
                                $('#username-error').text('');
                                $('button[name="addclientspos"]').prop('disabled', false);
                            }
                        }
                    });
                }
        ...
        <script>
        function updateCustomer(sale_id) {
            // Get selected customer ID from the dropdown
            var customer_id = document.getElementById('customer_select_' + sale_id).value;
            ...
            // AJAX request to update the customer in the database
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'update_customer.php', true);
            xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');

            // On success, update the customer name in the modal
            xhr.onload = function() {
                if (xhr.status == 200) {

                    window.location.href = 'pos.php?dinein_items=1';
                    document.getElementById('customer_name_display_' + sale_id).innerText =
                        document.getElementById('customer_select_' + sale_id).selectedOptions[0].text;

                }
            };

            // Send the data
            xhr.send('sale_id=' + sale_id + '&customer_name=' + customer_id);
        }
        </script>
        
        <script>
        function continueFunc(sale_id) {
            // Get selected customer ID from the dropdown
            var customer_id = document.getElementById('customer_select_' + sale_id).value;
            ...
            // AJAX request to update the customer in the database
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'continue_frame.php', true);
            xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
        ...
        <script>
        function updateCustomer2(sale_id) {
            // Get selected customer ID from the dropdown
            var customer_id = document.getElementById('customer_select_' + sale_id).value;
            ...
            // AJAX request to update the customer in the database
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'update_customer2.php', true);
            xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
            ...
            xhr.onload = function() {
                if (xhr.status == 200) {
                    ...
                    window.location.href = 'pos.php?dinein_items=1';
                    document.getElementById('customer_name_display_<?php echo $sale_id; ?>').innerText = document
                        .getElementById('customer_select_' + sale_id).selectedOptions[0].text;
        ...
        <?php if (isset($_GET['dinein_items']) && $_GET['dinein_items'] == '1'): ?>
        <script>
        window.onload = function() {

            var myModal = new bootstrap.Modal(document.getElementById('dinein_items'));
            myModal.show();
        };
        </script>
        <?php endif; ?>
        ...
        #table-buttons input[type="checkbox"]:checked+label {
            background-color: #28a745;
            /* Change to your desired selected color */
            color: white;
            /* Change text color if needed */
            border: 2px solid #0056b3;
            /* Optional: add a border to indicate selection */
        }
        ...
        #table-buttons input[type="checkbox"]:not(:checked)+label:hover {
        ...
        .tick {
            ...
            /* Smooth transition for tick */
        }

        #table-buttons input[type="checkbox"]:checked+label .tick {
            display: inline;
            /* Show the tick when selected */
            opacity: 1;
            /* Ensure tick is fully visible */
        }

        .table-name {
            font-size: 20px;
            /* Increase font size for table names */
            font-weight: 700;
        }
        ...
        /* <!-- Add some CSS to increase the font size of the dropdown options --> */
...
.mb-2, .my-2 {
    ...
    padding-top: 17px !important;
        ...
        /* manually control the stacking order of Bootstrap modals and their background overlay (called the backdrop) */

        #choosecustomer2.show {
        ...
        /* choosecustomer2 Modal background */
        #choosecustomer2 .modal-content {
        ...
        /* Modal header */
        #choosecustomer2 .modal-header {
            background-color: #004085;
            border-bottom: 2px solid black;
        }

        /* Modal title */
        #choosecustomer2 .modal-title {
            color: rgb(255, 255, 255);
        }

        /* Modal close button (X) */
        #choosecustomer2 .close {
            color: #fff;
            opacity: 0.8;
        }

        #choosecustomer2 .close:hover {
            opacity: 1;
        }

        /* Modal body labels */
        #choosecustomer2 label {
            color: rgb(255, 255, 255);
        }

        /* Form input fields */
        #choosecustomer2 input.form-control {
            color: black;
            border: 1px solid white;
        }

        /* Submit button */
        #choosecustomer2 button[type="submit"] {
            background-color: #007bff;
            border-color: #007bff;
            color: white;
        }

        #choosecustomer2 button[type="submit"]:hover {
            background-color: #0056b3;
        }

        /* //css for table status modal's table boxes */
        .time-and-dropdown-in-modal {
