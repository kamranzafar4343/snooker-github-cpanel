                            ...
                            <div style="margin-top: -10px;">
                                ...
                                <div id="buttons" style="padding-top:20px;" class="no-print">
                                    ...
                                    <span class="col-xs-12">
                                        <a class="btn btn-block btn-primary" style="margin-bottom: 10px; font-size: 16px; padding: 10px;" href="#" onclick="window.print();">Print</a>
                                        <a class="btn btn-block btn-success" style="font-size: 16px; padding: 10px;" href="pos_sale_list.php" target="_blank">Sale List</a>
                                        <a class="btn btn-block btn-warning" style="font-size: 16px; padding: 10px;" href="pos.php">Back to POS</a>
                                    </span>
