...
?>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> General Ledger</h2>
                        <ul class="breadcrumb">
  ...
  $("#danger-alert").hide();
    ...
    $("#danger-alert").fadeTo(4000, 500).slideUp(500, function() {
      $("#danger-alert").slideUp(500);
              ...
              <?php
                         ...
                         <form  action="trail_report.php" method="post" enctype="multipart/form-data">
                        <div class="body">
    ...
    <input type="date" class="form-control" name="f_date" placeholder="Item Name *" required="" >
                                    </div>
                                </div>
                            </div>
                                  <div class="row clearfix">
                              ...
                              <div class="col-md-5 ">
                                    ...
                                    <div class="form-group">
                                <input type="date" class="form-control" name="t_date" placeholder="Item Name *" required="">
                                    </div>
                                </div>
                            </div>
