            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Create New Direct Transfer (IEMI)</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item">Direct Transfer</li>
                            <li class="breadcrumb-item active">Add Direct Transfer (IEMI)</li>
                        </ul>
                    </div>            
                                      ...
                                      ?>
                                        <select class="form-control po"  name="po" onchange="get_detail();" >
                                          <option selected="" value="">-- Chose One --</option>
                                           <?php
                                            $sql="SELECT * FROM tbl_purchase_req where stock_status='Pending' and iemi='1' and transfer_type='1'"; 
                                            foreach ($conn->query($sql) as $row){
...
var edit_id=$('#edit_id').val();
  ...
  $.ajax({
                url: "operations/add_req_items_dir.php",
                type: "POST",
                data: { 
                    po : po,
                    edit_id : edit_id
...
if(qty=== undefined || isNAN(qty))
{
  ...
  var dataString = 'itemid='+ itemid + '&qty='+ qty + '&po='+ po;
    ...
    $.ajax({
type: "POST",
url: "operations/get_remaining_dir.php",
data: dataString,
