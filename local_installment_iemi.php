            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Local Installment (IEMI)</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"><i class="icon-home"></i></a></li>                            
                            <li class="breadcrumb-item"> Local Installment (IEMI)</li>
                               ...
                               <div class="col-md-4 col-sm-12">
                                  ...
                                  <div class="col-md-4 col-sm-12">
                                    <div class='col-md-8 col-sm-4' style="padding-bottom: 7px;">
                                       <a href="add_clients.php?sale_type=4">
 ...
 echo "</select>";
                                ...
                                <div class="col-md-4 col-sm-12">
                                   ...
                                   <div class="col-md-4 col-sm-12">
                                    ...
                                    <div class="form-group">        
                                        <input type="text" name="item_stock" id="item_stock"  class="form-control"  readonly="" placeholder="Item Stock" value="1">
                                </div>
                              </div>
                                </div>
                                <div class="col-md-4 col-sm-12" hidden="">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    <div class="form-group">        
                                        <input type="text" name="form_fee" id="form_fee" class="form-control"  readonly=""  value="200" required="">
                                </div>
                              </div>
                                </div>
