            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Local Purchase Return List</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>                            
                            <li class="breadcrumb-item">Local Purchase Return</li>
                            <li class="breadcrumb-item active">Local Purchase Return List</li>
                        </ul>
                    </div>            
              ...
              ?>
                        ...
                        <div class="body project_report">
                          ...
                          <div class=" text-right">
                              <a href="loc_purchase_return.php">
                          <button  class="btn btn-success m-b-15" type="button">
                                <i class="fa fa-plus-circle" aria-hidden="true"></i> Add/Edit Local Purchase Return
                            </button>
                          </a>
                          ...
                          <?php }?>
                            <div class="table-responsive">
                                ...
                                {
                                 $sql = mysqli_query($conn,"SELECT * FROM tbl_purchase_return where return_type='Local_purchase'  order by purchase_return_id asc");
                                }
                                else
                                {
                                  $sql = mysqli_query($conn,"SELECT * FROM tbl_purchase_return where return_type='Local_purchase' and created_by='$userid' order by purchase_return_id asc");
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td class="project-actions">
                                                ...
                                                <?php if($D=='1'){?>
                                                <a <?php echo $display;?> href="operations/delete.php?loc_purchase_return_id=<?php echo $purchase_id;?>" class="btn btn-sm btn-outline-danger js-sweetalert" title="Delete" onclick="return confirm('Are you sure want to delete');"><i class="icon-trash"></i></a>
                                                <?php }?>
                                            </td>
