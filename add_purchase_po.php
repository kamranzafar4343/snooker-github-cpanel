            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Create New Purchase With PO (IEMI)</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item">Purchase</li>
                            <li class="breadcrumb-item active">Add Purchase With PO (IEMI)</li>
                        </ul>
                    </div>            
                              ...
                              <div class="col-md-4 col-sm-12">
                                ...
                                <div class="col-md-4 col-sm-12">
                                     ...
                                     <div class='col-md-8 col-sm-4' style="padding-bottom: 7px;">
                                       ...
                                       <a href="add_vendors.php?add_type=1">
      ...
      var row_id = count_table_tbody_tr + 1;
              ...
              // console.log(reponse.x);
               var html = '<tr id="row_'+row_id+'">'+
                   '<td>'+ 
                    '<select class="form-control select_group product"  data-row-id="row_1" id="product_'+row_id+'" name="product[]" style="width:100%;"  required onchange="get_price('+row_id+')"><option value="">Choose Product</option><?php $sql="SELECT * FROM tbl_items WHERE category IN (SELECT id FROM `tbl_cat` where cat_name Like '%Mobile%')"; 
                                            foreach ($conn->query($sql) as $row){
                                            $brand_id=$row['brand_id'];
                                            $sql2=mysqli_query($conn,"SELECT cat_name from tbl_catagory where id='$brand_id'");
                                                $value2 = mysqli_fetch_assoc($sql2);
