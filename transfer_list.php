...
?>
  ...
  <strong>Great !</strong> Purchase Req has been Added.
</div>
                            <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
  ...
  <strong>Great !</strong> Purchase Req has been Deleted.
</div>
                            <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
              ...
              ?>
                        <div class="body project_report">
                          ...
                          <button  class="btn btn-info m-b-15" type="button">
                                <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Purchase Req (IEMI)
                            </button>
                          </a>
                          <a href="add_purchase_req.php">
                          <button  class="btn btn-warning m-b-15" type="button">
                                <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Purchase Req
                            </button>
                          </a> -->
                          <a href="dir_transfer_grn_iemi.php">
                          <button  class="btn btn-success m-b-15" type="button">
                                <i class="fa fa-plus-circle" aria-hidden="true"></i> Direct transfer GRN (IEMI)
                            </button>
                          </a>
                          <a href="direct_transfer_grn_gen.php">
                          <button  class="btn btn-warning m-b-15" type="button">
                                <i class="fa fa-plus-circle" aria-hidden="true"></i> Direct transfer GRN
                            </button>
                          </a>
                          ...
                          <?php }?>
                            <div class="table-responsive">
                                ...
                                $count=0;
                                    ...
                                    // $d_id=$_GET['d_id'];
                                $sql = mysqli_query($conn,"SELECT * FROM tbl_purchase_req where created_by='$userid' and transfer_type='1'");
                                ...
                                ?>
                                        ...
                                        <tr style="<?php echo $color;?>">
                                            ...
                                            <td><span class="badge badge-info"><?php echo $stock_receive_status;?></span></td>
                                            ...
                                            <td class="project-actions">
                                               ...
                                               <?php if($D=='1'){?>
                                                <a  <?php echo $display;?> href="operations/delete.php?direct_branch_id=<?php echo $purchase_req_id;?>"  <?php echo $display;?> class="btn btn-sm btn-outline-danger js-sweetalert" title="Delete" onclick="return confirm('Are you sure want to delete');"><i class="icon-trash"></i></a>
                                                <?php }?>
                                            </td>
                                          <?php }?>
                                        </tr>
