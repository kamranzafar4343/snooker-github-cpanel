            ...
            <div class="row clearfix" >
                <div class="col-lg-12 col-md-12">
                    <div class="card invoice1">                        
                        ...
                        $nsql=mysqli_query($conn, "SELECT created_date FROM tbl_single_purchase_detail ");
                        $ndata=mysqli_fetch_assoc($nsql);  // echo $data['c_phone '];exit();
                        $vsql=mysqli_query($conn, "SELECT vendor_id FROM tbl_single_purchase where purchase_id =$purchase_id ");
               ...
               // echo "string";
                        ...
                        $vendornamee = $dataa['username'];   ?>  
                            ...
                            <span > <b> DATE : </b> <?php $created_date=$ndata['created_date']; $newDate = date("d-m-Y", strtotime($created_date));
  echo $newDate;?>
                       </span>
                     </div> </div> 
                            <hr>  
      ...
      buttons: [
        {
          ...
          text: '<?php echo $c_name;?>',
           title: '<?php echo $c_name;?> (Local PO Items Report) for PO#<?php echo $purchase_id; ?>',
