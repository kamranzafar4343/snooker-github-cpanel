...
{
$vendors = mysqli_real_escape_string($conn,$_GET['customer']); 
  $f_date = mysqli_real_escape_string($conn,$_POST['f_date']);  
  $t_date = mysqli_real_escape_string($conn,$_POST['t_date']); 
    $newDate1 = date("d-m-Y", strtotime($f_date));
    $newDate2 = date("d-m-Y", strtotime($t_date));
   ...
   <div class="row clearfix" style="padding-right: calc(var(--bs-gutter-x) * 0.5);
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card invoice1">                        
                        ...
                        <div class="row">
                         ...
                         <form  action="get_customer_balance.php" method="post" enctype="multipart/form-data" id='form1'>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <select class="form-control select_group" name="vendors" id='van_id' >
                                        ...
                                        $sql="SELECT branch_id,created_by  FROM users where user_id='$userid'";
                                            ...
                                            else
                                            {
                                              ...
                                              $sql="SELECT * FROM tbl_customer where created_by='$userid'";
                                    ...
                                    foreach ($conn->query($sql) as $row){
                                        if($row['customer_id']==$vendors)
                                            {
                                            echo "<option value=$row[customer_id] selected>$row[username] $row[mobile_no]</option>";
                                            }
                                            else
                                            {
                                            echo "<option value=$row[customer_id]>$row[username] $row[mobile_no]</option>"; 
                                            }
                                     }
                                    echo "</select>";
                                     ?>
    ...
    padding-left: calc(var(--bs-gutter-x) * 0.5);">
                    ...
                    <div class="card invoice1">                        
                        ...
                        if($vendors=='All'){
                              ...
                              $where_vendor="";
                                ...
                                $where_vendor="where customer_id='$vendors'";
               ...
               <?php
                    ...
                    $sql5=mysqli_query($conn, "SELECT * FROM tbl_customer $where_vendor");
                      $count=0;
                        ...
                        $query11 = mysqli_query($conn,"SELECT opening_bal  FROM tbl_account_lv2 where acode='$vendor_id'"); 
                                   
                                   $zdata2 = mysqli_fetch_assoc($query11) ;
                                  $opening_bal=$zdata2['opening_bal'];
                        ...
                        $query10 = mysqli_query($conn,"SELECT SUM(d_amount-c_amount) as balance FROM tbl_trans_detail where acode='$vendor_id'"); 
                                   ...
                                   $balance1=$zdata1['balance'];
                                   $t_balance=round($balance1+$opening_bal);
$count++;
  ?>
                            <tr>
                            ...
                            <td class="text-right"><?php  $total_balance+=$t_balance; echo number_format($t_balance);?></td>
                            </tr>
                            <?php } ?>
                            <tr>
                            ...
                            <td hidden></td>
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-md-6 text-right">
                                            ...
                                            <h3 class="m-b-0 m-t-10">Receivable ( <?php echo number_format($total_balance); ?> )</h3>
                                        </div>                                    
