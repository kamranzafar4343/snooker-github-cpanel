            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Item History</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>                            
                            <li class="breadcrumb-item"> Item History Report </li>
...
<script src="assets/select2/dist/js/select2.min.js"></script>
  ...
  <script type="text/javascript">
    ...
    function get_items_stock()
    {
        ...
        $.ajax({
                    url:"operations/get_item_history.php",
                    method:"POST",
