                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"> Stock at Branch</li>
...
else
{
   ...
   ?>
                         ...
                         <form  action="stock_at_branch.php" id="form1"method="post" enctype="multipart/form-data">
                        <div class="body">
                        <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card invoice1">                        
                        <div class="body">
                            ...
                            <span class="text-right"> <b>FROM DATE/TO DATE : </b> <?php echo $f_date.'/'.$t_date;?>
                       </span></div> </div> 
                            <hr>  
                                              <div class="row clearfix">
                                        <div class="col-md-12">
